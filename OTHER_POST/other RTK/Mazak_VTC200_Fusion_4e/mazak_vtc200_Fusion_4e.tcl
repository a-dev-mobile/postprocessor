########################## TCL Event Handlers ##########################
#
#  mazak_vtc200_Fusion_4e.tcl -
#
#  Created by ronconi  @  quinta-feira, 18 de outubro de 2012 10:20:36 E. South America Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_cycle_drill_deep_code             "73" 
...
#=============================================================
   ...
   MOM_do_template end_of_program_5_1
   MOM_force Once M_coolant
   MOM_do_template coolant_off
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   PB_CMD_reposiciona
   MOM_force Once G_adjust G_motion G_mode H Z
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_adjust G_motion G_mode H X Y Z M_coolant}
   set rapid_spindle_x_blk {G_adjust G_motion G_mode H X M_coolant}
   set rapid_spindle_y_blk {G_adjust G_motion G_mode H Y M_coolant}
   set rapid_spindle_z_blk {G_adjust G_motion G_mode H Z M_coolant}
...
#=============================================================
   ...
   MOM_set_seq_on
   MOM_force Once G_cutcom G_adjust G_motion G_mode Text
...
set tempo_total	[format %.1f $mom_machine_time]
MOM_output_literal "(TEMPO TOTAL: $tempo_total min.)"
}
