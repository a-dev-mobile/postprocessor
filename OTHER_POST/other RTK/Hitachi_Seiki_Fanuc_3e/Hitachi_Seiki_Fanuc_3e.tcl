########################## TCL Event Handlers ##########################
#
#  Hitachi_Seiki_Fanuc_3e.tcl - 3_axis_mill
#
#    This is a 3-Axis Milling Machine.
#
#  Created by ronconi @ sexta-feira, 5 de janeiro de 2018 15:58:02 E. South America Daylight Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "Hitachi_Seiki_Fanuc_3e__IN.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_cycle_tap_code                    "841"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_rapid_feed_rate                   "6500"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_adjust G_motion X Y Z H S M_spindle M_coolant}
   set rapid_spindle_x_blk {G_adjust G_motion X H S M_spindle M_coolant}
   set rapid_spindle_y_blk {G_adjust G_motion Y H S M_spindle M_coolant}
   set rapid_spindle_z_blk {G_adjust G_motion Z H S M_spindle M_coolant}
   set rapid_traverse_blk {G_motion G_mode G X Y Z}
   set rapid_traverse_xy_blk {G_motion G_mode G X Y}
   set rapid_traverse_yz_blk {G_motion G_mode G Y Z}
   set rapid_traverse_xz_blk {G_motion G_mode G X Z}
...
set tempo    [format %.1f $mom_machine_time]
MOM_output_literal "(Tempo de Usinagem Total: $tempo min.)"
}
...
global mom_cutcom_status
 ...
 if {$mom_cutcom_status == "OFF" || $mom_cutcom_status == "UNDEFINED"} {MOM_suppress once D}
}
...
#=============================================================
proc PB_CMD_inicio_progama { } {
#=============================================================
global mom_logname mom_date mom_part_name pptype
set pptype    2
set ugppdir [MOM_ask_env_var "UGII_CAM_POST_DIR"]
# package ifneeded tbcload 1.3 [list load [file join $ugppdir/tbcload13.dll]]
# if {[catch {source [MOM_ask_env_var "UGII_CAM_POST_DIR"]pbnetchk.tbc}]} {
#       break
# }
#wursbteing
MOM_output_literal "(Arquivo: $mom_part_name)"
MOM_output_literal "(Programador: $mom_logname)"
MOM_output_literal "(Arquivo: $mom_date)"
MOM_output_literal "(Maquina: HITACHI_SEIKI18M)"
MOM_output_literal "(=============================================)"

MOM_suppress once  M_coolant M_spindle
}
...
global mom_tool_diameter mom_too_name

MOM_output_literal "(OPERACAO: $mom_path_name  FERRAMENTA T$mom_tool_number)"
...
#=============================================================
  MOM_force once G_adjust H G_motion G G_mode
}
