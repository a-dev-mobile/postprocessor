########################## TCL Event Handlers ##########################
#
#  HEIDENHAIN_tnc426_3e.tcl -
#
#  Created by ronconi  @  Mon Aug 23 16:22:53 2010 E. South America Daylight Time
...
#=============================================================
  global cycle_init_flag
   ...
   PB_CMD_cycle_init
   MOM_force Once X cycle_dwell M
...
#=============================================================
proc PB_CMD_Verifica_TLAXIS { } {
#=============================================================
global mom_tool_axis mom_cycle_spindle_axis

 if {$mom_tool_axis(0) == 1} {
      #-- eixo X --
      set mom_cycle_spindle_axis	0
 } elseif {$mom_tool_axis(1) == 1} {
            #-- eixo Y --
            set mom_cycle_spindle_axis	1
 } else {set mom_cycle_spindle_axis	2}
}
...
global mom_cutcom_adjust_register
global mom_sys_control_out  mom_sys_control_in
global flag_cb global flag_cb usr_controle_rev usr_data_rev
global co ci
global mom_kin_arc_output_mode  arc_mode_default
global mom_cycle_spindle_axis

#--- DEFAULT: Ferramenta no Eixo Z ----
...
set tempo_anterior   		0
set mom_cutcom_adjust_register	""
 ...
 MOM_output_literal "$co MAQUINA  : HEIDENHAIN 3 EIXOS - COMANDO: TNC426 $ci"
 MOM_output_literal "$co -------------------------------------------------------------- $ci"
 MOM_output_literal "$co POSPROCESSADOR: [ string toupper $mom_event_handler_file_name ] ) $ci"
 MOM_output_literal "$co REVISAO       : $usr_controle_rev          DATA: $usr_data_rev $ci" 
 MOM_output_literal "$co -------------------------------------------------------------- $ci"
...
# MOM_output_literal "FN 0: Q1 = 0"
# MOM_output_literal "FN 0: Q2 = 0"
...
#=============================================================
MOM_output_literal "L Z100. R0 F9999 M2"
}
...
#=============================================================
global mom_machine_time tempo_anterior mom_path_name

set tempo_oper	[expr $mom_machine_time - $tempo_anterior]

set tempo_oper	[format %.1f $tempo_oper]
MOM_output_literal "; === Tempo da Operacao: $mom_path_name = $tempo_oper min."
...
MOM_output_literal "; === Tempo Total de Usinagem: $tempo_u min."
}
...
set usr_data_rev	"18/JUL/07"
#-------------------------------------------------------------------------------------------------
#  Controle de alteracoes do pós-processador
#=================================================================================================
#  Data		Rev	Alterado por	Descricao
#=================================================================================================
# 18/JUL/07	---	Kleber		- Liberacao inicial;
#------------------------------------------------------------------------------
}


#=============================================================
proc PB_CMD_inicio_opereacao { } {
#=============================================================
