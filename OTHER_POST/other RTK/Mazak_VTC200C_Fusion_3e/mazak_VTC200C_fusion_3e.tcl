########################## TCL Event Handlers ##########################
#
#  mazak_VTC200C_fusion_3e.tcl - 3_axis_mill
#
#    This is a 3-Axis Milling Machine.
#
#  Created by ronconi @ terça-feira, 9 de janeiro de 2018 14:03:55 E. South America Daylight Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "mazak_VTC200C_fusion_3e__IN.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_coolant_code(TAP)                 "51"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_max_arc_radius                    "2000.0"
...
if {$HSMode == 1} {
    if {$mom_current_motion != "first_move" && $mom_current_motion != "initial_move"} {
        ...
        #MOM_output_literal "(HIGH SPEED MODE OFF)"
