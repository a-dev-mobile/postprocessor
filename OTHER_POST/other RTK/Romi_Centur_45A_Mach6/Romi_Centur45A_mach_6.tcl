########################## TCL Event Handlers ##########################
#
#  Romi_Centur45A_mach_6.tcl - lathe
#
#    
#
#  Created by ronconi @ sexta-feira, 5 de janeiro de 2018 11:27:56 E. South America Daylight Time
...
#
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_list_file_suffix                  "45U"
     set mom_sys_output_file_suffix                "45U"
  ...
  set mom_sys_alt_unit_post_name                "Romi_Centur45A_mach_6__IN.pui"
...
#=============================================================
 ...
 set usr_maquina    "TORNO ROMI CENTUR 45 - MACH6"
 #kr- ---------------------------------------------------------------------------------------------------
...
set tempo_anterior   $mom_machine_time
 ...
 if {$mom_next_oper_has_tool_change == "YES" || $mom_current_oper_is_last_oper_in_program  == "YES"} {
     ...
     MOM_output_literal "G0X500.Z1000.T00 M05"
     #MOM_output_literal " "
 }
...
#=============================================================
 ...
 if {$mom_spindle_maximum_rpm >= 670} {
   set usr_range 13
  } elseif {$mom_spindle_speed >= 210} {
        set usr_range 12
    ...
    if {$mom_spindle_maximum_rpm >= 670} {
   set usr_range 13
   } elseif {$mom_spindle_maximum_rpm >= 210} {
         set usr_range 12
     } else {set usr_range 11}
     MOM_output_literal "M$usr_range "
