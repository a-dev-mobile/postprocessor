########################## TCL Event Handlers ##########################
#
#  dyna_dm4800_meldas500_3e.tcl -
#
#  Created by ronconi  @  Fri Oct 24 11:33:22 2008 E. South America Daylight Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_output_file_suffix                "prg"
...
set tempo_anterior   0
 ...
 MOM_output_literal "$co MAQUINA  : DYNA DM4800 - COMANDO: MELDAS 500 $ci"
...
#=============================================================
proc PB_CMD_force_cutcom { } {
#=============================================================
global mom_tool_number T_num

MOM_force once D

set T_num	$mom_tool_number
}
...
#==============================================================================
# 24/OUT/08	 -	Kleber		- Liberacao inicial
#------------------------------------------------------------------------------
#
}
