########################## TCL Event Handlers ##########################
#
#  fadal_VMC4020_fa18i_4e.tcl -
#
#  Created by silvaw  @  Thu Oct 14 13:19:58 2010 E. South America Daylight Time
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_motion G_mode X Y Z fourth_axis S M_spindle M_coolant}
   set rapid_traverse_xy_blk {G_motion G_mode X Y fourth_axis S M_spindle M_coolant}
   set rapid_traverse_yz_blk {G_motion G_mode Y Z fourth_axis S M_spindle M_coolant}
   set rapid_traverse_xz_blk {G_motion G_mode X Z fourth_axis S M_spindle M_coolant}
...
global co ci
 ...
 MOM_output_literal "$co MAQUINA  : FADAL VMC4020 - COMANDO: FANUC 18i - 4e $ci"
...
#==============================================================================
# 26/JUN/09	---	Kleber		- Liberacao inicial;
#------------------------------------------------------------------------------
# 14/OUT/10	 A	William		- Liberacao inicial para 4e;
#------------------------------------------------------------------------------
#
#
#
