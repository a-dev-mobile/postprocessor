########################## TCL Event Handlers ##########################
#
#  ms_duravertical5100_faOI_4e.tcl -
#
#  Created by ronconi  @  Mon Apr 26 13:41:39 2010 E. South America Daylight Time
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_4th_axis_max_limit                "99999"
  set mom_kin_4th_axis_min_incr                 "0.001"
  set mom_kin_4th_axis_min_limit                "-99999"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_adjust G_mode G_motion X Y Z H S}
   set rapid_spindle_x_blk {G_adjust G_mode G_motion X H S}
   set rapid_spindle_y_blk {G_adjust G_mode G_motion Y H S}
   set rapid_spindle_z_blk {G_adjust G_mode G_motion Z H S}
   set rapid_traverse_blk {G_mode G_motion G X Y Z fourth_axis M_coolant}
   set rapid_traverse_xy_blk {G_mode G_motion G X Y fourth_axis M_coolant}
   set rapid_traverse_yz_blk {G_mode G_motion G Y Z fourth_axis M_coolant}
   set rapid_traverse_xz_blk {G_mode G_motion G X Z fourth_axis M_coolant}
...
#=============================================================
   ...
   MOM_force Once G_cutcom G_motion G
...
#=============================================================
proc PB_CMD_ini_oper { } {
#=============================================================
global mom_path_name mom_tool_number mom_tool_name

MOM_output_literal "(OPER $mom_path_name)"
MOM_output_literal "(FERR T$mom_tool_number - $mom_tool_name)"
...
MOM_output_literal "(PP.REV. 05 - 26/ABR/10)"

global mom_output_G28
set mom_output_G28 1
}
