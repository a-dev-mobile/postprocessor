########################## TCL Event Handlers ##########################
#
#  Discovery_D1250_fa0i_4e.tcl -
#
#  Created by silvaw  @  sexta-feira, 20 de maio de 2016 15:16:17 E. South America Standard Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "Discovery_D1250_fa0i_4e__IN.pui"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_5th_axis_center_offset(2)         "95"
...
#=============================================================
   ...
   MOM_force Once G_adjust G_motion G Z D H M_coolant
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_adjust G_motion X Y Z D H M_coolant}
   set rapid_spindle_x_blk {G_adjust G_motion X D H M_coolant}
   set rapid_spindle_y_blk {G_adjust G_motion Y D H M_coolant}
   set rapid_spindle_z_blk {G_adjust G_motion Z D H M_coolant}
...
global co ci
 ...
 MOM_output_literal ";$co MAQUINA  : ROMI DISCOVERY D1250 4E - COMANDO: FANUC 0i $ci"
...
MOM_output_to_listing_device "================================================"
MOM_output_to_listing_device "          A T E N Ç Ã O  !  !  !"
MOM_output_to_listing_device ""
MOM_output_to_listing_device "      Operação $mom_path_name não suportada."
MOM_output_to_listing_device ""
MOM_output_to_listing_device "      Pós-processamento abortado."
MOM_output_to_listing_device "================================================"
MOM_output_to_listing_device ""

MOM_abort "Operação $mom_path_name não suportada."
}
...
#==============================================================================
# 03/NOV/11    ---    Kleber        - Liberacao inicial;
#------------------------------------------------------------------------------
# 20/MAI/16     A     WILLIAM        - Liberacao inicial para Avibras;
#------------------------------------------------------------------------------
#
...
#
   ...
   set mom_kin_reengage_distance             3.0
...
#  set mom_pos(2) 3.0
   ...
   MOM_output_literal "(-- REPOSICIONAMENTO DOS EIXOS ANGULARES --)"
   MOM_do_template linear_move
}
...
#=============================================================
  MOM_force once M_spindle S X Y Z F R fourth_axis
}
