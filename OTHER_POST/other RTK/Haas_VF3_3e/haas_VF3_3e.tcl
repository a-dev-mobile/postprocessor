...
#  haas_VF3_3e.tcl -
#
#  Created by ronconi  @  quinta-feira, 23 de maio de 2013 08:47:31 E. South America Standard Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "haas_VF3_3e__IN.pui"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_fix G_motion G_mode X Y Z}
   set rapid_traverse_xy_blk {G_fix G_motion G_mode X Y}
   set rapid_traverse_yz_blk {G_fix G_motion G_mode Y Z}
   set rapid_traverse_xz_blk {G_fix G_motion G_mode X Z}
...
#=============================================================
   ...
   MOM_force Once G_return G_mode
...
set tempo_anterior   0
 ...
 MOM_output_literal "$co POS-PROC : HASS VF-3 3 EIXOS - REV: $usr_controle_rev - $usr_data_rev $ci"
...
#=====================================================================================
# 05/jan/09    .00    Kleber        - Liberacao inicial;
#-------------------------------------------------------------------------------------
#
}
