########################## TCL Event Handlers ##########################
#
#  Torno_Mazak_Generic_ISO.tcl - lathe
#
#    
#
#  Created by ronconi @ sexta-feira, 5 de janeiro de 2018 15:07:43 E. South America Daylight Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "Torno_Mazak_Generic_ISO__IN.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_tool_change_code                  "999"
...
#=============================================================
   ...
   MOM_force Once G_spin S M_spindle M_coolant
...
set tempo_anterior   0
 ...
 MOM_output_literal "$co MAQUINA  : MAZAK - COMANDO: MAZAK - ISO $ci"
 #MOM_output_literal "$co --------------------------------------------------------------  $ci"
 #MOM_output_literal "$co POSPROCESSADOR: [ string toupper $mom_event_handler_file_name ] )  $ci"
 #MOM_output_literal "$co --------------------------------------------------------------  $ci"
 #Se nao for Heidenhain, deletar esta linhas e as 2 proximas
...
#==============================================================================
# 04/NOV/2011   A        WRS        - Liberacao inicial MWL;
#
