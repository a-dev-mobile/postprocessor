########################## TCL Event Handlers ##########################
#
#  MAZAK_VCN510C_NEXUS_4e.tcl - 4_axis_table
#
#    This is a 4-Axis Milling Machine With
#     Rotary Table.
#
#  Created by ronconi @ sexta-feira, 5 de janeiro de 2018 16:09:23 E. South America Daylight Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "MAZAK_VCN510C_NEXUS_4e__IN.pui"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_4th_axis_max_limit                "999"
  set mom_kin_4th_axis_min_incr                 "0.001"
  set mom_kin_4th_axis_min_limit                "-999"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_spindle_blk {G_mode G_motion G_adjust H X Y Z M_coolant}
   set rapid_spindle_x_blk {G_mode G_motion G_adjust H X M_coolant}
   set rapid_spindle_y_blk {G_mode G_motion G_adjust H Y M_coolant}
   set rapid_spindle_z_blk {G_mode G_motion G_adjust H Z M_coolant}
...
if {$HSMode == 1} {
    if {$mom_current_motion != "first_move" && $mom_current_motion != "initial_move"} {
        MOM_output_literal "G05 P0 (HIGH SPEED MODE OFF)"
        MOM_output_literal "G64 (PARADA EXATA OFF)"
    }
...
if {$HSMode == 2} {
    MOM_output_literal "G61.1 (PARADA EXATA ON)"
    MOM_output_literal "G05 P2 (HIGH SPEED MODE ON)"
    set HSMode    1
    MOM_suppress once D
...
#==============================================================================
# 07/jul/05    ---    Kleber        - Liberacao inicial;
#------------------------------------------------------------------------------
# 14/maio/13     A    William       - Gerado 4e de pos 3e em uso na Neumayer;
#------------------------------------------------------------------------------
#
}
...
proc MOM_HSM_mode {} {
#-----------------------------------------------------
  global mom_High_Speed_mode
  global HSMode

  if {$mom_High_Speed_mode == "ON"} {set HSMode    1}
}
#=========================================================================
}
...
set ci             $mom_sys_control_in
 ...
 MOM_output_literal "$co DES:           RD:     RP:      $ci"
 MOM_output_literal "$co REV. DO PROGRAMA:               $ci"
 ...
 MOM_output_literal "$co CENTRO DE USINAGEM MAZAK VCN 510c $ci"
# MOM_output_literal "$co EXECUTAR BLOCO A BLOCO $ci"
 MOM_output_literal "$co OPERADOR:            DATA:    /   /     $ci"
 MOM_output_literal "$co ALT. SOL:/           DATA:    /   /     $ci"
