########################## TCL Event Handlers ##########################
#
#  fagor_8035MR_3e.tcl - 3_axis_mill
#
#    FREE MILL : This is a 3-Axis Milling Machine.
#
#  Created by ronconi @ sexta-feira, 5 de janeiro de 2018 15:17:50 E. South America Daylight Time
...
#
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_output_file_suffix                "pim"
  ...
  set mom_sys_alt_unit_post_name                "fagor_8035MR_3e__IN.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_post_description                  "FREE MILL : This is a 3-Axis Milling Machine."
...
#=============================================================
   ...
   PB_CMD_cabecalho
   MOM_force Once G_mode G_motion G_return G
...
set tempo_anterior   0
 ...
 MOM_output_literal "$co MAQUINA  : FRESADORA 3 EIXOS - COMANDO: FAGOR 8035MR $ci"
...
#=============================================================
proc PB_CMD_calcula_incr_G83 { } {
#=============================================================
global cycl_I  cycl_J mom_cycle_feed_to mom_cycle_step1

set cycl_J  [expr int(abs($mom_cycle_feed_to/$mom_cycle_step1)+0.99)]
set cycl_I  [expr abs($mom_cycle_feed_to)/$cycl_J]
}
...
#==============================================================================
# 29/JUL/10    ---    Kleber        - Liberacao inicial;
#------------------------------------------------------------------------------
#
#
#
