########################## TCL Event Handlers ##########################
#
#  DMC_635_Ecoline_G40.tcl - 3_axis_mill
#
#    Это 3-осевой фрезерный станок.
#
#  Created by VolkovVR @ Friday, November 15 2019, 13:37:24 +0300
...
#
  ...
  set mom_sys_alt_unit_post_name                "DMC_635_Ecoline_G40__IN.pui"
...
#=============================================================
   ...
   MOM_force Once G_cutcom G_mode G G_plane_1
...
MOM_output_literal  T="[string toupper $mom_tool_name]"
