########################## TCL Event Handlers ##########################
#
#  romi_discovery_D1250_s810d_4e.tcl -
#
#  Created by silvaw  @  Friday, July 19, 2013 1:20:06 AM E. South America Standard Time
#  with Post Builder version  8.0.3.
#
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "romi_discovery_D1250_s810d_4e__IN.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_leader(fourth_axis)               "W=DC("
  ...
  set mom_sys_post_builder_version              "8.0.3"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_4th_axis_leader                   "W=DC("
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   MOM_force Once G_plane G_feed G_motion G_mode G
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_spindle_blk {G_motion G_mode G X Y Z D M_coolant}
   set rapid_spindle_x_blk {G_motion G_mode G X D M_coolant}
   set rapid_spindle_y_blk {G_motion G_mode G Y D M_coolant}
   set rapid_spindle_z_blk {G_motion G_mode G Z D M_coolant}
   set rapid_traverse_blk {G_motion G_mode G X Y Z M_coolant}
   set rapid_traverse_xy_blk {G_motion G_mode G X Y M_coolant}
   set rapid_traverse_yz_blk {G_motion G_mode G Y Z M_coolant}
   set rapid_traverse_xz_blk {G_motion G_mode G X Z M_coolant}
...
#=============================================================
 ...
 MOM_output_literal "$co MAQUINA    : ROMI D1250 4 EIXOS - COMANDO: SINUMERIK 810D $ci"
 #MOM_output_literal "$co --------------------------------------------------------------  $ci"
...
#==============================================================================
# 02/MAI/12    ---    Kleber        - Liberacao inicial PAINCO;
#------------------------------------------------------------------------------
# 17/JUL/13     A     WR            - Eliminado extensao de saida, ADIC MPF ;
#                                    e HELIX sem K;
#------------------------------------------------------------------------------
#
}
