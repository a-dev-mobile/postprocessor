########################## TCL Event Handlers ##########################
#
#  Created by ronconi  @  Fri Dec 16 12:22:49 2005 E. South America Daylight Time
...
set tempo_anterior   0
 ...
 MOM_output_literal "$co MAQUINA  : MAKINO V22 - COMANDO: FANUC 30i $ci"
 MOM_output_literal "$co --------------------------------------------------------------  $ci"
 MOM_output_literal "$co POSPROCESSADOR: [ string toupper $mom_event_handler_file_name ] $ci"
 MOM_output_literal "$co Rev.: $usr_controle_rev    Data: $usr_data_rev   PB: V3.4.1$ci"
 MOM_output_literal "$co --------------------------------------------------------------  $ci"
}
...
#==============================================================================
# dd/dez/05	---	Kleber		- Liberacao inicial;
#------------------------------------------------------------------------------
#
#
#
