########################## TCL Event Handlers ##########################
#
#  romi_D1500_sinumerik_828d_3e.tcl -
#
#  Created by ronconi  @  quinta-feira, 26 de janeiro de 2017 12:08:45 E. South America Daylight Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "romi_D1500_sinumerik_828d_3e__IN.pui"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_motion G_mode G X Y Z S M_spindle}
   set rapid_traverse_xy_blk {G_motion G_mode G X Y S M_spindle}
   set rapid_traverse_yz_blk {G_motion G_mode G Y Z S M_spindle}
   set rapid_traverse_xz_blk {G_motion G_mode G X Z S M_spindle}
...
#=============================================================
 ...
 global co ci  tr_flag  cycle_flag
 ...
 MOM_output_literal "$co MAQUINA    : ROMI DYSCOVERY 1500 3EIXOS - COMANDO: SINUMERIK 828D $ci"
 #MOM_output_literal "$co --------------------------------------------------------------  $ci"
...
#------------------------------------------------------------------------------
# 17/JUL/13    .01     WR            - Eliminado extensao de saida, ADIC MPF ;
#                                    e HELIX sem K;
#------------------------------------------------------------------------------
# 26/JAN/17    .02     KR            - Removida a linha G0 G53 Z0 D0 das trocas;
#                                    - Adicionado G64 no inicio do programa
#                                    - Removida linha G0 G53 Z0 D0 do final do programa.
#------------------------------------------------------------------------------
#
#
#
...
#=============================================================
proc PB_CMD_rpm_range { } {
#=============================================================
global mom_spindle_speed

if {$mom_spindle_speed <= 1200} {
