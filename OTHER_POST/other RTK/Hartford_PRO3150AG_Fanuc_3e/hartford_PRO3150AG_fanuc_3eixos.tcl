########################## TCL Event Handlers ##########################
#
#  hartford_PRO3150AG_fanuc_3eixos.tcl -
#
#  Created by ronconi  @  terça-feira, 31 de julho de 2012 08:52:41 E. South America Standard Time
...
global co ci
 ...
 MOM_output_literal "$co\## MAQUINA  : HARTFORD 3EIXOS - COMANDO: FANUC $ci"
...
#==============================================================================
# 31/AGO/12    ---    Kleber        - Liberacao inicial;
#------------------------------------------------------------------------------
#
...
#=============================================================
  MOM_force once M_spindle S X Y Z F R
}
...
global ci co
 ...
 MOM_output_literal "$co\## - FERR.: T$mom_tool_number $mom_tool_name $ci"
}
