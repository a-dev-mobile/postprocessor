########################## TCL Event Handlers ##########################
#
#  Created by ronconi  @  Thu Dec 14 09:24:24 2006 E. South America Standard Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_cycle_drill_code                  "80" 
  ...
  set mom_sys_leader(fourth_axis)               " ;  INCL="
  set mom_sys_leader(fifth_axis)                "W"  
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_4th_axis_leader                   " ;  INCL="
  ...
  set mom_kin_min_arc_length                    ".5" 
  set mom_kin_min_arc_radius                    ".5" 
...
#=============================================================
   ...
   MOM_force Once G_motion user_add_2 Z D M_spindle
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_motion G_mode X Y Z M_coolant}
   set rapid_spindle_x_blk {G_motion G_mode X M_coolant}
   set rapid_spindle_y_blk {G_motion G_mode Y M_coolant}
   set rapid_spindle_z_blk {G_motion G_mode Z M_coolant}
...
proc PB_CMD_F_ciclo { } {
#=============================================================
 global mom_feed_cut_value mom_operation_type

 if {$mom_operation_type == "Point to Point"} {        	
     MOM_suppress always M_coolant
     MOM_suppress once F
     #MOM_output_literal "F[format "%.2f" $mom_feed_cut_value]"
     MOM_output_literal "M08"
 } else {
	MOM_force once M_coolant
	}

 #MOM_output_literal "CFTCP"
 #MOM_output_literal "G64"
 MOM_force once G_motion X Y F M_coolant
}
...
#=============================================================
proc PB_CMD_bore_move { } {
#=============================================================
#_______________________________________________________________________________
# This procedure is executed for the goto of a drill cycle.
#_______________________________________________________________________________
 global ciclo mom_feed_cut_value

 MOM_force once cycle_parameters_RTP cycle_parameters_RFP cycle_parameters_SDIS cycle_parameters_DP
 MOM_force once cycle_parameters_DPR 	
 MOM_force once cycle_parameters_DTB cycle_parameters_FFR cycle_parameters_REF
 if {$ciclo == "1"} {
     set ciclo	"0"
     MOM_output_literal "F[format "%.2f" $mom_feed_cut_value]"
     MOM_do_template cycle_bore_on
...
set tempo_anterior   0
 ...
 MOM_output_literal "$co MAQUINA  : Discovery 560 - COMANDO: Sinumerik 810D $ci"
...
#_______________________________________________________________________________
 ...
 MOM_force once cycle_parameters_RTP cycle_parameters_RFP cycle_parameters_SDIS cycle_parameters_DP
 MOM_force once cycle_parameters_DPR cycle_parameters_FDEP cycle_parameters_FDPR cycle_parameters_DAM	
 MOM_force once cycle_parameters_DTB cycle_parameters_DTS cycle_parameters_FRF cycle_parameters_VARI

 if {$ciclo == "1"} {
     set ciclo	"0"
     MOM_output_literal "F[format "%.2f" $mom_feed_cut_value]"
     MOM_do_template cycle_drill_deep_on
...
MOM_force once cycle_parameters_RTP cycle_parameters_RFP cycle_parameters_SDIS cycle_parameters_DP
 ...
 if {$ciclo == "1"} {
     set ciclo	"0"
     MOM_output_literal "F[format "%.2f" $mom_feed_cut_value]"
     MOM_do_template cycle_drill_on
     MOM_do_template cycle_drill
 } else { 
	 MOM_do_template cycle_drill 
 }
...
#==============================================================================
# 09/set/04	---	Kleber		- Liberacao inicial;
#------------------------------------------------------------------------------
#
#
#
...
#=============================================================
global program_start  tempo_acumulado

set program_start 	1
set tempo_acumulado	0
}
...
#_______________________________________________________________________________
 ...
 MOM_force once cycle_parameters_RTP cycle_parameters_RFP cycle_parameters_SDIS cycle_parameters_DP
 MOM_force once cycle_parameters_DPR cycle_parameters_DTB cycle_parameters_SDAC cycle_parameters_MPIT
 MOM_force once cycle_parameters_PIT cycle_parameters_POSS cycle_parameters_SST cycle_parameters_SST1
 MOM_force once cycle_parameters_SDR cycle_parameters_ENC

 if {$ciclo == "1"} {
     set ciclo	"0"
     MOM_output_literal "F[format "%.2f" $mom_feed_cut_value]"
     MOM_do_template cycle_tap_on
     MOM_do_template cycle_drill
 } else { 
	 MOM_do_template cycle_drill
 }
...
MOM_output_literal ";===================================================="
#MOM_output_literal ";(TEMPO TOTAL: [format "%.2f" $mom_machine_time] min.)"
}


#=============================================================
proc PB_CMD_drill_dwell_move { } {
#=============================================================
#_______________________________________________________________________________
# This procedure is executed for the goto of a drill cycle.
#_______________________________________________________________________________
...
MOM_force once cycle_parameters_RTP cycle_parameters_RFP cycle_parameters_SDIS cycle_parameters_DP
 ...
 if {$ciclo == "1"} {
     set ciclo	"0"
     MOM_output_literal "F[format "%.2f" $mom_feed_cut_value]"
     MOM_do_template cycle_drill_dwell_on
     MOM_do_template cycle_drill
 } else { 
	 MOM_do_template cycle_drill 
 }
...
#_______________________________________________________________________________
 ...
 if {$ciclo == "1"} {
     set ciclo	"0"
     MOM_output_literal "F[format "%.2f" $mom_feed_cut_value]"
     MOM_do_template cycle_drill_brkchp_on
     MOM_do_template cycle_drill
 } else { 
	 MOM_do_template cycle_drill 
 }
...
#_______________________________________________________________________________
 ...
 if {$ciclo == "1"} {
     set ciclo	"0"
     MOM_output_literal "F[format "%.2f" $mom_feed_cut_value]"
     MOM_do_template cycle_bore_drag_on
     MOM_do_template cycle_drill
 } else { 
	 MOM_do_template cycle_drill 
 }
...
#_______________________________________________________________________________
 ...
 if {$ciclo == "1"} {
     set ciclo	"0"
     MOM_output_literal "F[format "%.2f" $mom_feed_cut_value]"
     MOM_do_template cycle_bore_no_drag_on
     MOM_do_template cycle_drill
 } else { 
	 MOM_do_template cycle_drill 
 }
