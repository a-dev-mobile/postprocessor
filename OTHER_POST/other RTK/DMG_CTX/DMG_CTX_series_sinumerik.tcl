########################## TCL Event Handlers ##########################
#
#  DMG_CTX_series_sinumerik.tcl - 5_axis_head_table
#
#    This is a 5-Axis Milling Machine With
#     Rotary Head and Table.
#
#  Created by ronconi @ sexta-feira, 5 de janeiro de 2018 15:09:00 E. South America Daylight Time
...
# 08-21-2015 szl - Fix PR7471332:Parse error during machine code simulation if the UDE Operator Message is added.
  ...
  set mom_sys_alt_unit_post_name                "DMG_CTX_series_sinumerik__IN.pui"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_plane G_feed G_motion G_mode X Y Z fifth_axis S D M_spindle}
...
#=============================================================
  ...
  global mom_sys_machine_time mom_machine_time
   ...
   MOM_output_literal ";( Operacao: $mom_operation_name )"
...
#
  global mom_date
  global mom_part_name mom_output_file_basename
  ...
  if { ![info exists start_output_flag] || $start_output_flag == 0 } {
     ...
     MOM_output_text "%_N_$mom_output_file_basename\_MPF"
     MOM_output_text ";\$PATH=/_N_WKS_DIR/_N_PRG_WPD"
     MOM_output_text ";(PP. REV.: .01 - 09/MAR/17) "
