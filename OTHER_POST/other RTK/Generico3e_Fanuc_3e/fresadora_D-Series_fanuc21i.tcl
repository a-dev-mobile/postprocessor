########################## TCL Event Handlers ##########################
#
#  fresadora_D-Series_fanuc21i.tcl - 3_axis_mill
#
#    This is a 3-Axis Milling Machine.
#
#  Created by ronconi @ quarta-feira, 24 de maio de 2017 10:58:23 E. South America Standard Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "fresadora_D-Series_fanuc21i__IN.pui"
...
#=============================================================
   ...
   MOM_force Once G_motion G Z_zero H
...
set tempo_anterior   0
 ...
 MOM_output_literal "$co MAQUINA  : D-SERIES - COMANDO: FANUC21i $ci"
...
#==============================================================================
# 02/jan/06    ---    Kleber        - Liberacao inicial;
#------------------------------------------------------------------------------
#
#
#
