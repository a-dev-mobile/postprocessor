########################## TCL Event Handlers ##########################
#
#  feeler_FV760a_fanuc_4e_t.tcl -
#
#  Created by ronconi  @  Wed Apr 25 12:01:04 2007 E. South America Daylight Time
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_home_pos(0)                       "-750"
  set mom_sys_home_pos(1)                       "-5" 
  set mom_sys_home_pos(2)                       "-30"
  set mom_sys_zero                              "0"  
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_4th_axis_max_limit                "999999.999"
  set mom_kin_4th_axis_min_incr                 "0.001"
  set mom_kin_4th_axis_min_limit                "-999999.999"
...
#=============================================================
   MOM_force Once Text Z M_coolant
   MOM_do_template return_Z
   MOM_force Once Text X Y M_coolant
   MOM_do_template return_XY
   MOM_force Once Text
   MOM_do_template csys_g54
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   PB_CMD_destrava_eixo
   MOM_do_template rapid_move_4th
   PB_CMD_verifica_travamento_eixo
...
global mom_tool_axis mom_path_name
 ...
 if {$mom_tool_axis(0) > 0.001} {
     MOM_output_to_listing_device " "
     MOM_output_to_listing_device "    ============================================="
     MOM_output_to_listing_device "    ==  ATENCAO:                               "
     MOM_output_to_listing_device "    == --------------------------------------- "
     MOM_output_to_listing_device "    ==  TLAXIS COM COMPONENTE EM X:($mom_tool_axis(0))"
     MOM_output_to_listing_device "    ==  VERIFICAR OPERACAO: $mom_path_name "
...
set 2pt	"\:"
 ...
 MOM_output_text $2pt$mom_output_file_basename
 ...
 MOM_output_literal "$co MAQUINA  : FEELER FV760A 4E - COMANDO: FANUC $ci"
...
#=============================================================
proc PB_CMD_destrava_eixo { } {
#=============================================================
global lock_4th  mom_rotary_delta_4th

if {$lock_4th == "ON" && $mom_rotary_delta_4th != 0} {
    MOM_do_template return_Z
    MOM_do_template csys_g54
    PB_CMD_unclamp_fourth_axis
} elseif {$lock_4th == "x"} {
          PB_CMD_unclamp_fourth_axis
} else { MOM_suppress once fourth_axis }
}
...
#==============================================================================
# 23/ABR/07	 -	Kleber		- Liberação inicial
#------------------------------------------------------------------------------
#
#
#
...
#=============================================================
  MOM_force once G G_adjust X Y Z H S
}
...
#=============================================================
proc PB_CMD_verifica_travamento_eixo { } {
#=============================================================
global op_type  lock_4th
