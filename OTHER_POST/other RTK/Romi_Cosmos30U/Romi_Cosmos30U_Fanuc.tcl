########################## TCL Event Handlers ##########################
#
#  Romi_Cosmos30U_Fanuc.tcl - lathe
#
#    
#
#  Created by ronconi @ sexta-feira, 5 de janeiro de 2018 11:25:07 E. South America Daylight Time
...
#
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_list_file_suffix                  "30U"
     set mom_sys_output_file_suffix                "30U"
  ...
  set mom_sys_alt_unit_post_name                "Romi_Cosmos30U_Fanuc__IN.pui"
...
#=============================================================
 ...
 set usr_maquina    "TORNO COSMOS 30U - FANUC_MACH6"
 #kr- ---------------------------------------------------------------------------------------------------
 ...
 MOM_output_text ":$mom_output_file_basename ($usr_descricao)"
 #MOM_output_text $L(1)
 for {set j 2} {$j<9} {incr j} {
      set i    [expr 55 - [string length $L($j)]]
...
set tempo_anterior   $mom_machine_time
 ...
 if {$mom_next_oper_has_tool_change == "YES" || $mom_current_oper_is_last_oper_in_program  == "YES"} {
     ...
     MOM_output_literal "G0X470.Z450.T00"
     #MOM_output_literal " "
 }
...
set master_rev        ".00"
set master_rev_date    "10/AGO/15"

#==============================================================================
#  DATA        Revisao        Resp      Descricao
#==============================================================================
# 10/AGO/15    .00            ERC        - Liberação inicial
#------------------------------------------------------------------------------
#
}
...
MOM_force once M_coolant F G_motion X Z
