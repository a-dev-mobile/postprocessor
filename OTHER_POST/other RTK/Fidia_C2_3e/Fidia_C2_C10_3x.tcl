...
#  Fidia_C2_C10_3x.tcl -
#
#  Created by ronconi  @  segunda-feira, 8 de janeiro de 2018 16:13:43 E. South America Daylight Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "Fidia_C2_C10_3x__IN.pui"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_spindle_blk {G_adjust G_motion G_mode X Y Z M_coolant}
   set rapid_spindle_x_blk {G_adjust G_motion G_mode X M_coolant}
   set rapid_spindle_y_blk {G_adjust G_motion G_mode Y M_coolant}
   set rapid_spindle_z_blk {G_adjust G_motion G_mode Z M_coolant}
...
# MOM_output_literal "$co MAQUINA  : FIDIA D165 S - COMANDO: CNC FIDIA C01$ci"
# MOM_output_literal "$co ARQUIVO  : $mom_part_name  $ci"
 MOM_output_literal "$co FEITO POR: $mom_logname - DATA: $mom_date  $ci"
...
#==============================================================================
# 19/set/08    ---    William        - Liberacao inicial;
#------------------------------------------------------------------------------
# 18/ago/09     A    William        - Eliminado T M06 e H;
#------------------------------------------------------------------------------
}
...
global mom_stock_part mom_inside_outside_tolerances
global co ci

set stk        [format %.3f "$mom_stock_part"]
set tlrin   [format %.3f "$mom_inside_outside_tolerances(0)"]
set tlrout  [format %.3f "$mom_inside_outside_tolerances(1)"]

MOM_output_literal "$co OPERACAO: $mom_path_name - FERR.: T$mom_tool_number $mom_tool_name $ci"

MOM_output_literal "$co SOBREMETAL: $stk   TOLERANCIA: in=$tlrin / out=$tlrout $ci"
}
