########################## TCL Event Handlers ##########################
#
#  Romi_Centur_40RV_Meldas_E70.tcl -
#
#  Created by silvaw  @  Tuesday, September 06, 2016 7:48:35 AM E. South America Standard Time
...
#=============================================================
   ...
   PB_CMD_cabecalho
   MOM_set_seq_on
   MOM_force Once G_cutcom G_feed G_mode G
...
set tempo_anterior   0
 ...
 MOM_output_literal "$co MAQUINA   : TORNO ROMI CENTUR 40RV - COMANDO: MITSUBISHI E70 $ci"
 MOM_output_literal "$co REVISAO PP: .01 - 21/AGO/15 $ci"
...
#MOM_output_literal "$co $ci"
#MOM_output_literal "$co MODO     : TURNING  $ci"
...
#=============================================================
 global mom_spindle_mode mom_spindle_speed mom_spindle_maximum_rpm
 global usr_rpm_range

  if {$mom_spindle_mode == "RPM"} {

     if {$mom_spindle_speed > 1260} {
         set usr_rpm_range "M13"
     } elseif {$mom_spindle_speed > 420} {
         set usr_rpm_range "M12"
     } else {set usr_rpm_range "M11"}
     ...
     if {$mom_spindle_maximum_rpm > 1260} {
         set usr_rpm_range "M13"
     } elseif {$mom_spindle_maximum_rpm > 420} {
         set usr_rpm_range "M12"
     } else {set usr_rpm_range "M11"}
