########################## TCL Event Handlers ##########################
#
#  pinnacle_QV147_4e_meldasM70.tcl - 4_axis_table
#
#    This is a 4-Axis Milling Machine With
#     Rotary Table.
#
#  Created by ronconi @ sexta-feira, 5 de janeiro de 2018 16:15:00 E. South America Daylight Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "pinnacle_QV147_4e_meldasM70__IN.pui"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   PB_CMD_verif_ang
   set rapid_spindle_blk {G_adjust G_motion G X Y Z H M_coolant}
   set rapid_spindle_x_blk {G_adjust G_motion G X H M_coolant}
   set rapid_spindle_y_blk {G_adjust G_motion G Y H M_coolant}
   set rapid_spindle_z_blk {G_adjust G_motion G Z H M_coolant}
   set rapid_traverse_blk {G_cutcom G_motion G_mode G X Y Z fourth_axis S M_spindle}
   set rapid_traverse_xy_blk {G_cutcom G_motion G_mode G X Y fourth_axis S M_spindle}
   set rapid_traverse_yz_blk {G_cutcom G_motion G_mode G Y Z fourth_axis S M_spindle}
   set rapid_traverse_xz_blk {G_cutcom G_motion G_mode G X Z fourth_axis S M_spindle}
...
#=============================================================
   ...
   PB_CMD_cabecalho
   MOM_set_seq_on
   MOM_force Once G_cutcom G_plane G_feed G_motion G_mode
...
global co ci
 ...
 MOM_output_literal "$co MAQUINA  : PINNACLE QV147 4EIXOS - COMANDO: MITISUBISHI-M70 $ci"
...
MOM_output_to_listing_device " "
MOM_output_to_listing_device "  SIEMENS PLM BRASIL PELO TELEFONE (11) 4224-7111."
MOM_output_to_listing_device " "
MOM_output_to_listing_device " "
MOM_output_to_listing_device " ================================================== "
}
...
#=============================================================
MOM_force once G_motion X Y fourth_axis fifth_axis
}
...
#==============================================================================
# 15/JUL/10    .00    Kleber        - Liberacao inicial;
#------------------------------------------------------------------------------
# 10/set/10    .01   WR             - Liberacao inicial EQUITRON,alterado G54;
#------------------------------------------------------------------------------
# 27/MAI/15    .02    Kleber        - Ajustes gerais;
#------------------------------------------------------------------------------
...
global mom_tool_diameter  mom_tool_name mom_tool_number mom_tool_diameter
global co ci

 #MOM_output_literal "$co   $ci"
 MOM_output_literal "$co OP: $mom_path_name - FERR.: T$mom_tool_number $mom_tool_name $ci"
...
#=============================================================
proc PB_CMD_verif_ang { } {
#=============================================================
global mom_init_out_angle_pos mom_out_angle_pos
global mom_rotary_delta_4th mom_rotary_delta_5th

set ang1    [expr $mom_rotary_delta_4th + $mom_rotary_delta_5th]
