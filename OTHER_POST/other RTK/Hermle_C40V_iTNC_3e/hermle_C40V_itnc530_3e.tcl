########################## TCL Event Handlers ##########################
#
#  hermle_C40V_itnc530_3e.tcl - 3_axis_mill
#
#    This is a 3-Axis Milling Machine.
#
#  Created by ronconi @ quinta-feira, 17 de agosto de 2017 09:32:29 E. South America Standard Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "hermle_C40V_itnc530_3e__IN.pui"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_motion X Y Z G_cutcom F M_coolant}
   set rapid_spindle_x_blk {G_motion X G_cutcom F M_coolant}
   set rapid_spindle_y_blk {G_motion Y G_cutcom F M_coolant}
   set rapid_spindle_z_blk {G_motion Z G_cutcom F M_coolant}
...
global co ci
 ...
 MOM_output_literal "$co MAQUINA  : HERMLE C40V - COMANDO: ITNC530 $ci"
...
#==============================================================================
# 16/AGO/17    ---    Kleber        - Liberacao inicial;
#------------------------------------------------------------------------------
#
}
...
global co ci
 ...
 MOM_output_text "$co   $ci"
 MOM_output_text "$co ==== OPERACAO: $mom_path_name - FERR.: T$mom_tool_number $mom_tool_name $ci"
 MOM_output_text "$co ======================================================================= $ci"
