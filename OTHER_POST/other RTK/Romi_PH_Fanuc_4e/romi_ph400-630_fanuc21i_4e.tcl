########################## TCL Event Handlers ##########################
#
#  romi_ph400-630_fanuc21i_4e.tcl -
#
#  Created by silvaw  @  Thursday, July 18, 2013 4:48:50 PM E. South America Standard Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "romi_ph400-630_fanuc21i_4e__IN.pui"
...
#=============================================================
   ...
   MOM_force Once G_motion G Z H
   MOM_do_template return_Z_home
...
#=============================================================
   ...
   MOM_force Once Text fourth_axis
...
set tempo_anterior   0
 ...
 MOM_output_literal "$co MAQUINA  : Romi Discovery PH400/630 - 4 Eixos - COMANDO: FANUC 21i $ci"
 MOM_output_literal "$co Rev. PP  : $usr_controle_rev    Data: $usr_data_rev   $ci"
}


#=============================================================
proc PB_CMD_check_angle { } {
#=============================================================
global last_4th mom_out_angle_pos mom_path_name

if {![info exists last_4th]} {set last_4th    99999999999}

set bV    [format %.3f $mom_out_angle_pos(0)]
set bVi   [lindex [split $bV "."] 0]
set Bdec  [expr $bV - $bVi]

if {$Bdec != 0} {
    MOM_abort "OPERACAO: $mom_path_name => ANGULO B NAO EH VALOR INTEIRO!! => B=$bV"
}

if { $bV != $last_4th } {
    MOM_force once G Z H
#    MOM_do_template return_Z_home
    MOM_force once G_motion fourth_axis
    MOM_do_template rapid_4th

    set last_4th    [format %.3f $mom_out_angle_pos(0)]
}
}
...
#==============================================================================
# 03/MAI/12    ---    Kleber        - Liberacao inicial PAINCO;
#------------------------------------------------------------------------------
# 17/JUL/13     A     William       - Eliminado extensao;
#------------------------------------------------------------------------------
#
}
...
#=============================================================
  MOM_force once G_adjust H S G_motion G Z H
}
