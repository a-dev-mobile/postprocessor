########################## TCL Event Handlers ##########################
#
#  mazak_FJV250_nexus_3e.tcl - 3_axis_mill
#
#    
#
#  Created by ronconi @ quinta-feira, 17 de agosto de 2017 09:18:26 E. South America Standard Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "mazak_FJV250_nexus_3e__IN.pui"
...
#=============================================================
   ...
   MOM_force Once G_mode G_return H Z
...
MOM_output_text "$co ------- Tempo da Operacao: $tempo_oper min. $ci"
MOM_output_text " "
...
#==============================================================================
# 16/AGO/17    .00    Kleber        - Liberacao inicial;
#------------------------------------------------------------------------------
#
}
...
MOM_output_text "( OPERACAO: $mom_path_name - T$mom_tool_number $mom_tool_name)"

if { [info exists mom_tool_corner1_radius] } {
    MOM_output_text "( DIAM. [format "%.2f" $mom_tool_diameter] RC [format "%.2f" $mom_tool_corner1_radius] )"
} else {
      MOM_output_text "( DIAM. [format "%.2f" $mom_tool_diameter] )"
}
}
...
set ci             $mom_sys_control_in
 ...
 MOM_output_literal "$co MAZAK  FJV250 NEXUS $ci"
 MOM_output_literal "$co -------------------------------------------------------------- $ci"
 MOM_output_literal "$co REV. PP.: $usr_controle_rev - $usr_data_rev $ci"
 MOM_output_literal "$co -------------------------------------------------------------- $ci"
