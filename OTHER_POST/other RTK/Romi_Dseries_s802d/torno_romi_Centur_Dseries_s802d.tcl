########################## TCL Event Handlers ##########################
#
#  torno_romi_Centur_Dseries_s802d.tcl -
#
#  Created by ronconi  @  sexta-feira, 5 de janeiro de 2018 10:32:52 E. South America Daylight Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "torno_romi_Centur_Dseries_s802d__IN.pui"
...
#=============================================================
   ...
   MOM_force Once G_motion X Z R F
...
#=============================================================
   ...
   MOM_force Once G G_cutcom G_mode G_feed
...
global tempo_anterior mom_output_file_basename
global mom_sys_control_out  mom_sys_control_in
global co ci
...
regsub -all ":" $mom_date "." mom_date
regsub -all ":" $mom_event_handler_file_name "" mom_event_handler_file_name

#MOM_output_literal ";$mom_output_file_basename (MAQ.=TORNO ROMI CENTUR 50D - ARQ.= [string toupper $mom_part_name] - FEITO POR= [string toupper $mom_logname] - DATA= [string toupper $mom_date])"

#MOM_output_literal "$co (Escolha o cabecalho, abaixo) $ci"
#MOM_output_literal ";(MAQ.=TORNO ROMI CENTUR 50D - ARQ.= [string toupper $mom_part_name] - FEITO POR= [string toupper $mom_logname] - DATA= [string toupper $mom_date])"

#MOM_output_literal "$co OU $ci"

MOM_output_literal "$co (ARQUIVO  : [string toupper $mom_part_name]) $ci"
MOM_output_literal "$co (FEITO POR: [string toupper $mom_logname]) $ci"
MOM_output_literal "$co (DATA     : [string toupper $mom_date]) $ci"
MOM_output_literal "$co (MAQUINA  : TORNO ROMI CENTUR 50D - S802D) $ci"
...
#=============================================================
proc PB_CMD_contador { } {
#=============================================================
MOM_output_literal "\$AC_ACTUAL_PARTS=(\$AC_ACTUAL_PARTS+1)"
MOM_output_literal "\$AC_TOTAL_PARTS=(\$AC_TOTAL_PARTS+1)"
}
...
#=============================================================
global mom_delay_mode mom_delay_revs

MOM_output_literal "(==> $mom_delay_mode  $mom_delay_revs )"
}
...
#=============================================================
global mom_path_name  mom_tool_number  mom_tool_adjust_register mom_tool_name

#MOM_output_literal ";T$mom_tool_number - OPERACAO: $mom_path_name "
...
#==============================================================
# 03/12/08    -    kleber        Liberação inicial
#--------------------------------------------------------------
# 08/01/09    A    kleber        Alterado conf. solicitado
#--------------------------------------------------------------
# 14/05/09    B    William        Liberação inicial para Rontan
#--------------------------------------------------------------
# 17/03/10    C    William        Liberação inicial para VSE
#--------------------------------------------------------------
}
