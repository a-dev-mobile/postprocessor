########################## TCL Event Handlers ##########################
#
#  romi_discovery_Dseries_fanuc_4e.tcl -
#
#  Created by ronconi  @  quarta-feira, 7 de novembro de 2012 16:36:12 E. South America Daylight Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "romi_discovery_Dseries_fanuc_4e__IN.pui"
...
global co ci
 ...
 MOM_output_literal "$co MAQUINA  : ROMI DISCOVERY D Series 4E - COMANDO: FANUC $ci"
