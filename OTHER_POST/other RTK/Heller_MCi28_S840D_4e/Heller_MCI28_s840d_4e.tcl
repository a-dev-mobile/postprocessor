########################## TCL Event Handlers ##########################
#
#  Heller_MCI28_s840d_4e.tcl -
#
#  Created by silvaw  @  Wednesday, October 03, 2012 12:58:15 PM E. South America Standard Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_output_file_suffix                "ARC"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_coolant_code(THRU)                "21" 
  set mom_sys_coolant_code(TAP)                 "21" 
  ...
  set mom_sys_leader(fourth_axis)               "B=DC("
  ...
  set mom_sys_post_builder_version              "7.5.5"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_4th_axis_leader                   "B=DC("
...
#=============================================================
   ...
   PB_CMD_usr_B_angle
   PB_CMD_check_cycle85
   PB_call_macro CYCLE85 MCALL
...
#=============================================================
   ...
   PB_CMD_cycle_abort
   MOM_do_template cycle_bore_back_1
...
#=============================================================
   ...
   PB_CMD_usr_B_angle
   PB_CMD_check_cycle83_0
   MOM_do_template cycle_drill_break_chip_1
   PB_call_macro CYCLE83 MCALL
...
#=============================================================
  ...
  global mom_motion_event
   ...
   PB_CMD_simulation_trans
   PB_CMD_coolant_check
   set rapid_spindle_blk {G_motion G_mode G X Y Z D}
   set rapid_spindle_x_blk {G_motion G_mode G X D}
   set rapid_spindle_y_blk {G_motion G_mode G Y D}
   set rapid_spindle_z_blk {G_motion G_mode G Z D}
   set rapid_traverse_blk {G_motion G_mode G X Y Z fourth_axis S M_spindle}
   set rapid_traverse_xy_blk {G_motion G_mode G X Y fourth_axis S M_spindle}
   set rapid_traverse_yz_blk {G_motion G_mode G Y Z fourth_axis S M_spindle}
   set rapid_traverse_xz_blk {G_motion G_mode G X Z fourth_axis S M_spindle}
...
#=============================================================
   ...
   PB_CMD_usr_B_angle
   PB_CMD_check_cycle84
   PB_CMD_simulation_feed
   MOM_do_template tap
...
#=============================================================
proc PB_CMD_cabec_definition { } {
#=============================================================
global mom_usr_peca mom_usr_desenho mom_usr_programador mom_usr_prog_data
global mom_usr_last_rev mom_usr_revisado_por mom_usr_rev_data co ci

MOM_set_seq_off

 MOM_output_literal "$co ---------------------------------------------- $ci"
 MOM_output_literal "$co PECA           : $mom_usr_peca    $ci"
 MOM_output_literal "$co DESENHO        : $mom_usr_desenho $ci"
 MOM_output_literal "$co PROGRAMADO POR : $mom_usr_programador $ci"
 MOM_output_literal "$co DATA           : $mom_usr_prog_data $ci"
 MOM_output_literal "$co ---------------------------------------------- $ci"
 MOM_output_literal "$co ULTIMA REVISAO : $mom_usr_last_rev $ci"
 MOM_output_literal "$co REVISADO POR   : $mom_usr_revisado_por $ci"
 MOM_output_literal "$co DATA           : $mom_usr_rev_data $ci"
 MOM_output_literal "$co ----------------------------------------------  $ci"
...
#=============================================================
 ...
 MOM_output_literal "$co ARQUIVO    : $mom_part_name  $ci"
 #MOM_output_literal "$co PECA       :     $ci"
 MOM_output_literal "$co PROGRAMADOR: $mom_logname   $ci"
 MOM_output_literal "$co DATA       : $mom_date   $ci"
 #MOM_output_literal "$co REVISAO    :  $ci"
 MOM_output_literal "$co MAQUINA    : HELLER MCI 28 - COMANDO: S840D $ci"
 #MOM_output_literal "$co --------------------------------------------------------------  $ci"
 #MOM_output_literal "$co POSPROCESSADOR: [ string toupper $mom_event_handler_file_name ] $ci"
 MOM_output_literal "$co Rev. PP: $usr_controle_rev    Data: $usr_data_rev   $ci"
 MOM_output_literal "$co --------------------------------------------------------------  $ci"
...
#=============================================================
proc PB_CMD_carrega_ponto_zero { } {
#=============================================================
MOM_output_literal ";CARREGAR PONTO ZERO"


#MOM_output_literal ";CARREGAR PONTO ZERO EM G54"
MOM_output_literal "\$P_UIFR\[1\]=CTRANS(X,0,Y,0,Z,0,B,0);G54"
#MOM_output_literal ";CARREGAR PONTO ZERO EM G55"
MOM_output_literal "\$P_UIFR\[2\]=CTRANS(X,0,Y,0,Z,0,B,0);G55"
#MOM_output_literal ";CARREGAR PONTO ZERO EM G56"
MOM_output_literal "\$P_UIFR\[3\]=CTRANS(X,0,Y,0,Z,0,B,0);G56"
#MOM_output_literal ";CARREGAR PONTO ZERO EM G57"
MOM_output_literal "\$P_UIFR\[4\]=CTRANS(X,0,Y,0,Z,0,B,0);G57"
}


#=============================================================
proc PB_CMD_check_cycle81 { } {
#=============================================================
global mom_cycle_retract_to_pos mom_cycle_spindle_axis
global mom_pos mom_cycle_spindle_axis
global mom_cycle_rapid_to
global mom_cycle_feed_to_pos mom_cycle_spindle_axis
global cycle_flag
global usr_RTP usr_RFP usr_SDIS usr_DP

if {![info exists cycle_flag]} {set cycle_flag    0}

if {$cycle_flag == 0} {
    set usr_RTP        $mom_cycle_retract_to_pos($mom_cycle_spindle_axis)
    set usr_RFP        $mom_pos($mom_cycle_spindle_axis)
    set usr_SDIS       $mom_cycle_rapid_to
    set usr_DP         $mom_cycle_feed_to_pos($mom_cycle_spindle_axis)

} else {
        if {$usr_RTP != $mom_cycle_retract_to_pos($mom_cycle_spindle_axis)} {
        set usr_RTP        $mom_cycle_retract_to_pos($mom_cycle_spindle_axis)
        set cycle_flag    0
    }
    if {$usr_RFP != $mom_pos($mom_cycle_spindle_axis)} {
            set usr_RFP        $mom_pos($mom_cycle_spindle_axis)
        set cycle_flag    0
    }
    if {$usr_SDIS !=    $mom_cycle_rapid_to} {
        set usr_SDIS    $mom_cycle_rapid_to
        set cycle_flag    0
    }
    if {$usr_DP != $mom_cycle_feed_to_pos($mom_cycle_spindle_axis)} {
        set usr_DP         $mom_cycle_feed_to_pos($mom_cycle_spindle_axis)
        set cycle_flag    0
    }
}

#---- Se nao eh o primeiro furo e não mudou parametro, gera coord. XY e sai ----
if {$cycle_flag == 1} {
    MOM_do_template cycle_drill
    MOM_abort_event
}
...
global cycle_flag
global usr_RTP usr_RFP usr_SDIS usr_DP usr_DTB
global mom_cycle_delay_mode

if {![info exists mom_cycle_delay]} {set mom_cycle_delay    0}
if {![info exists mom_cycle_delay_revs]} {set mom_cycle_delay_revs    0}

set _DTB     0

if {$mom_cycle_delay_mode == "SECONDS"} {
    set _DTB    $mom_cycle_delay
} else {set _DTB    [expr -1 * $mom_cycle_delay_revs]}
...
#=============================================================
proc PB_CMD_check_cycle83_0 { } {
#=============================================================
global mom_cycle_retract_to_pos mom_cycle_spindle_axis
global mom_pos mom_cycle_spindle_axis
global mom_cycle_rapid_to
global mom_cycle_feed_to_pos mom_cycle_spindle_axis
global mom_cycle_delay mom_cycle_delay_revs mom_cycle_delay_mode
global mom_cycle_step1 mom_cycle_step2 mom_cycle_step3
global cycle_flag
global usr_RTP usr_RFP usr_SDIS usr_DP usr_FDEP usr_FDPR usr_DAM usr_DTB usr_DTS
global usr_FRF usr_VARI usr_AXN usr_MDEP usr_VRT usr_DTD usr_DIS1

if {![info exists mom_cycle_delay]} {set mom_cycle_delay    0}
if {![info exists mom_cycle_delay_revs]} {set mom_cycle_delay_revs    0}

if {$mom_cycle_step2 == 0} {set mom_cycle_step2  $mom_cycle_step1}

set _FDEP   [expr $mom_pos($mom_cycle_spindle_axis) - $mom_cycle_step1]
set _DTB     0
...
global mom_cycle_feed_rate_per_rev mom_spindle_speed
global cycle_flag
global usr_RTP usr_RFP usr_SDIS usr_DP usr_DPR usr_DTB usr_SDAC usr_MPIT usr_PIT usr_POSS
global usr_SST usr_SST1 usr_AXN usr_PTAB usr_TECHNO usr_VARI usr_DAM usr_VTR
global mom_cycle_delay_mode
global mom_cycle_cam mom_tool_diameter

if {![info exists mom_cycle_cam]} {set mom_cycle_cam    0}
if {![info exists mom_cycle_delay]} {set mom_cycle_delay    0}
if {![info exists mom_cycle_delay_revs]} {set mom_cycle_delay_revs    0}

set _DTB     0
set _DAM     $mom_cycle_feed_to_pos($mom_cycle_spindle_axis)
if {$mom_cycle_cam != 0} {set _DAM [expr $mom_tool_diameter * 0.5]}
...
if {$cycle_flag == 0} {
    ...
    set usr_SDAC   5
    #set usr_MPIT  ""
    set usr_PIT    $mom_cycle_feed_rate_per_rev
    set usr_POSS   0
    set usr_SST    $mom_spindle_speed
    #set usr_SST1  $usr_SST
    set usr_AXN    3
    set usr_PTAB   1
    set usr_TECHNO 0
    set usr_VARI   $mom_cycle_cam
    set usr_DAM    $_DAM
    #set usr_VTR   ""
        ...
        #if {$usr_SDAC    != $mom_sys_spindle_direction_code($mom_spindle_direction)} {
        #    set usr_SDAC     $mom_sys_spindle_direction_code($mom_spindle_direction)
        #    set cycle_flag    0
        #}
        if {$usr_PIT != $mom_cycle_feed_rate_per_rev} {
              set usr_PIT       $mom_cycle_feed_rate_per_rev
              set cycle_flag    0
        }
        if {$usr_SST != $mom_spindle_speed} {
            set usr_SST       $mom_spindle_speed
            set cycle_flag 0
        }
        if {$usr_VARI != $mom_cycle_cam} {
            set usr_VARI       $mom_cycle_cam
            set cycle_flag 0
        }
        if {$usr_DAM != $_DAM} {
...
global cycle_flag
global usr_RTP usr_RFP usr_SDIS usr_DP usr_DPR usr_DTB usr_SDR usr_SDAC usr_ENC usr_MPIT
global usr_PIT usr_AXN usr_PTAB usr_TECHNO
global mom_cycle_delay_mode
...
global mom_cycle_step1 mom_cycle_step2 mom_cycle_step3
global mom_sys_spindle_direction_code mom_spindle_direction
global mom_cycle_feed_rate_per_rev feed
global cycle_flag
global usr_RTP usr_RFP usr_SDIS usr_DP usr_DPR usr_DTB usr_FFR usr_RFF
global mom_cycle_delay_mode
...
global mom_cycle_feed_rate_per_rev feed
global cycle_flag
global usr_RTP usr_RFP usr_SDIS usr_DP usr_DPR usr_DTB usr_SDIR usr_RPA
global usr_RPO usu_RPAP usr_POSS
global mom_cycle_delay_mode
...
if {$cycle_flag == 0} {
    ...
    set usr_DP     $mom_cycle_feed_to_pos($mom_cycle_spindle_axis)
    set usr_DTB    $_DTB
    set usr_SDIR   $mom_sys_spindle_direction_code($mom_spindle_direction)
    set usr_RPA    0
    set usr_RPO    -0.3
    set usu_RPAP   0
    set usr_POSS   0
        ...
        if {$usr_SDIR    != $mom_sys_spindle_direction_code($mom_spindle_direction)} {
            set usr_SDIR   $mom_sys_spindle_direction_code($mom_spindle_direction)
            set cycle_flag    0
        }
...
MOM_output_literal "=>111"
    ...
    if {$usr_RFP != $mom_pos($mom_cycle_spindle_axis)} {
        set usr_RFP       $mom_pos($mom_cycle_spindle_axis)
        set cycle_flag    0
MOM_output_literal "=>222"
    }
    if {$usr_SDIS !=     $mom_cycle_rapid_to} {
        set usr_SDIS     $mom_cycle_rapid_to
        set cycle_flag   0
MOM_output_literal "=>333"
    }
    if {$usr_DP != $mom_cycle_feed_to_pos($mom_cycle_spindle_axis)} {
        set usr_DP         $mom_cycle_feed_to_pos($mom_cycle_spindle_axis)
        set cycle_flag     0
MOM_output_literal "=>444"
    }
    if {$usr_DTB != $_DTB} {
        set usr_DTB        $_DTB
        set cycle_flag     0
MOM_output_literal "=>555"
    }
}
...
#=============================================================
proc PB_CMD_coolant_check { } {
#=============================================================
global usr_coolant mom_coolant_status
global mom_motion_event
...
if {$mom_coolant_status == "TAP"} {
    set usr_coolant    21
} elseif {$mom_coolant_status == "THRU"} {
    set usr_coolant    21
} else { unset usr_coolant}
#MOM_output_literal "==> ($mom_coolant_status)"

if {$mom_coolant_status == "TAP"} {
        MOM_suppress once  S M_spindle
        MOM_force once D M_coolant user_M
} else {
        MOM_force once D S M_spindle M_coolant user_M
}
...
#=============================================================
proc PB_CMD_cycle_abort { } {
#=============================================================
global mom_path_name

MOM_abort "==> OPERACAO: $mom_path_name -> CICLO NAO SUPORTADO!!!"
}


#=============================================================
proc PB_CMD_def_cycle_text_move { } {
#=============================================================
...
global mom_cycle_retract_to_pos mom_cycle_spindle_axis
global mom_pos mom_cycle_spindle_axis
global mom_cycle_rapid_to  mom_cycle_cam  feed
global mom_cycle_feed_to_pos mom_cycle_spindle_axis  mom_cycle_feed_rate_per_rev
global mom_cycle_text  mom_tool_pitch mom_tool_type mom_tool_direction
global cycle_flag
global usr_RTP usr_RFP usr_SDIS usr_DP usr_diath usr_kdiath usr_cdir usr_typth
...
if {![info exists cycle_flag]} {set cycle_flag    0}
 ...
 set usr_SDIS       $mom_cycle_rapid_to
 set usr_DP         $mom_cycle_feed_to_pos($mom_cycle_spindle_axis)
 set usr_diath      [lindex [split $mom_cycle_text ","] 1]
 set usr_kdiath     [lindex [split $mom_cycle_text ","] 2]

 if {$mom_tool_pitch != $mom_cycle_feed_rate_per_rev} {
     MOM_abort " ERRO: Avanco da operação diferente do passo da ferramenta de roscar!!!"
 }

 if {$mom_tool_type != "Thread Mill"} {
     MOM_abort " ERRO: Ferramenta de roscar não é do tipo THREAD MILL!!!"
 }

 set usr_cdir    [expr $mom_tool_direction + 1]

 if {[info exists mom_cycle_cam]} {
     set usr_typth    $mom_cycle_cam
 } else {set usr_typth        0}

MOM_do_template feed_rate_value
PB_CMD_usr_B_angle
PB_call_macro CYCLE90
...
#=============================================================
proc PB_CMD_desloc_origem { } {
#=============================================================
global flag_sim g_lista ii

#--- Verifica se está simulando
if {$flag_sim == 0} {
    MOM_output_literal " "
    MOM_output_literal ";--------- DESLOCAMENTO DE ORIGEM ($ii posicoes) --------------"

    set jj    1
    while {$jj <= $ii} {
           MOM_output_literal " [lindex $g_lista $jj]"
           incr jj
    }
...
#=============================================================
global mom_machine_time tempo_anterior
global co ci

 set tempo_oper    [expr $mom_machine_time - $tempo_anterior]

 set tempo_oper    [format %.1f $tempo_oper]
 MOM_output_literal "$co ------- Tempo da Operacao: $tempo_oper min. $ci"
 #MOM_output_literal "$co   $ci"
...
#=============================================================
proc PB_CMD_final_programa { } {
#=============================================================
global mom_machine_time
global co ci

 set tempo_u    [format %.1f $mom_machine_time]
 MOM_output_literal "$co ---- Tempo Total de Usinagem: $tempo_u min. $ci"
}
...
#=============================================================
proc PB_CMD_fixture_offset_check { } {
#=============================================================
# A MÁQUINA TEM 99 POSSIBILIDADES DE ZERO PEÇA, QUE SÃO IDENTIFICADOS POR UM NÚMERO SEQUENCIAL QUE FICA ENTRE COLCHETES[NUMERO]
# [1]   - G54
# [2]   - G55
# [3]   - G56
# [4]   - G57
...
# [55]  - G555
# [56]  - G556
# [57]  - G557....  e assim por diante...
#
#=================================================================
global mom_fixture_offset_value usr_fixture_offset
global last_offset

##--- Guarda ultimo offset usado -----
if {![info exists last_offset]} {
    set last_offset    0
} else {set last_offset    $usr_fixture_offset}

#MOM_output_literal "==> $mom_fixture_offset_value"

if {$mom_fixture_offset_value > 6 && $mom_fixture_offset_value < 54} {
    MOM_abort "==> FIXTURE OFFSET deve ser menor que 7 ou maior que 53 !! "
}

if {$mom_fixture_offset_value < 7} {
    set usr_fixture_offset    [expr $mom_fixture_offset_value + 53]
} elseif {$mom_fixture_offset_value > 53} {
    set usr_fixture_offset    [expr $mom_fixture_offset_value + 500]
}
}


#=============================================================
proc PB_CMD_force_address_1 { } {
#=============================================================
MOM_force once S M F
}


#=============================================================
proc PB_CMD_force_fourth_axis { } {
#=============================================================
...
proc PB_CMD_go_home { } {
#=============================================================
global mom_simulation


MOM_output_literal ";"
MOM_output_literal "G53 G0 X900 Y1000"

MOM_output_literal ";"
#MOM_output_literal "CS_WPC"
...
#-- Atualizar estas variáveis com a letra e data da ultima revisao.... --------
 set usr_controle_rev    "A"
 set usr_data_rev    "03/OUT/12"
#------------------------------------------------------------------------------
...
#==============================================================================
# 03/MAI/12    ---    Kleber        - Liberacao inicial;
#------------------------------------------------------------------------------
# 03/OUT/12     A     WILLIAM      - Liberacao inicial CESTARI ;
#------------------------------------------------------------------------------
#
}
...
global co ci
 ...
 MOM_output_literal "$co   $ci"
 MOM_output_literal "$co OPERACAO: $mom_path_name - FERR.: T$mom_tool_number $mom_tool_name $ci"

#-----------------------------------------------------------------------------
global mom_post_in_simulation  flag_sim

if {[info exists mom_post_in_simulation] && $mom_post_in_simulation != 0} {
    if {![info exists flag_sim]} {
        set flag_sim    1
        MOM_output_literal "SIM_INI ;($mom_post_in_simulation)"
    }
} else {set flag_sim    0}
...
return
 ...
 if { $mom_spindle_speed == 0 } {
     ...
     MOM_output_to_listing_device "   ======================================="
     MOM_output_to_listing_device "    ATENCAO!!! OPERACAO: $mom_path_name"
     MOM_output_to_listing_device "    ERRO: ROTACAO ZERO NAO PERMITIDA!!!!"
     MOM_output_to_listing_device "   - - - - - - - - - - - - - - - - - - - -"
     MOM_output_to_listing_device "   => POS-PROCESSAMENTO INTERROMPIDO !!!!"
     MOM_output_to_listing_device "   ======================================="
     MOM_abort " ERRO: ROTACAO ZERO NAO PERMITIDA! "
 } elseif { $mom_tool_number == 0 } {
     MOM_output_to_listing_device " "
     MOM_output_to_listing_device "   ======================================="
     MOM_output_to_listing_device "    ATENCAO!!! OPERACAO: $mom_path_name"
     MOM_output_to_listing_device "    ERRO: FERRAMENTA T0 NAO PERMITIDA!!!!"
     MOM_output_to_listing_device "   - - - - - - - - - - - - - - - - - - - -"
     MOM_output_to_listing_device "   => POS-PROCESSAMENTO INTERROMPIDO !!!!"
     MOM_output_to_listing_device "   ======================================="
     MOM_abort " ERRO: FERRAMENTA T0 NAO PERMITIDA! "
 }
...
#=============================================================
proc PB_CMD_retract_Z { } {
#=============================================================
global usr_B_angle   last_usr_B_angle
global tr_flag  spindle_first   mom_motion_event
global usr_fixture_offset
global last_offset

#MOM_output_literal ";=====> $mom_motion_event $usr_B_angle ==> last= $last_usr_B_angle "

if {$usr_B_angle != $last_usr_B_angle || $mom_motion_event == "initial_move"} {
    PB_CMD_trans_reset
    MOM_force once G_motion G Z D
    #MOM_do_template rapid_Z_home
    MOM_do_template auto_tool_retract
    MOM_force once G_motion G X Y fourth_axis
    set spindle_first FALSE
    set last_offset    $usr_fixture_offset
} elseif {$usr_fixture_offset != $last_offset} {
          set last_offset    $usr_fixture_offset
          MOM_force once G X Y fourth_axis
} else {
        MOM_suppress once G_motion fourth_axis
}
...
#=============================================================
proc PB_CMD_simulation_feed { } {
#=============================================================
global flag_sim

if {$flag_sim != 1} {MOM_suppress once F}
}


#=============================================================
proc PB_CMD_simulation_trans { } {
#=============================================================
global tr_flag mom_csys_matrix mom_csys_origin
global mom_simulation  usr_fixture_offset
global last_TXX last_TYY last_TZZ last_TRANS
global g_lista out_line_0 out_line ii
global usr_fixture_offset mom_fixture_offset_value
global init_trans
return
if {![info exists init_trans]} {set init_trans    0}


#MOM_output_literal ";|$mom_csys_matrix(0)|$mom_csys_matrix(1)|$mom_csys_matrix(2)||X $mom_csys_origin(0)"
#MOM_output_literal ";|$mom_csys_matrix(3)|$mom_csys_matrix(4)|$mom_csys_matrix(5)||Y $mom_csys_origin(1)"
#MOM_output_literal ";|$mom_csys_matrix(6)|$mom_csys_matrix(7)|$mom_csys_matrix(8)||Z $mom_csys_origin(2)"

#--- Inicializa variaveis do TRANS
set reset_TRANS "TRANS X0.0 Y0.0 Z0.0"

if {![info exists g_lista]}  {lappend g_lista    "\$P_UIFR\[0\]=CTRANS(X,0.000,Y,0.000,Z,0.000,B,0); G53"}
if {![info exists ii]}       {set ii   0}
if {![info exists last_TXX]} {set last_TXX   0}
if {![info exists last_TYY]} {set last_TYY   0}
if {![info exists last_TZZ]} {set last_TZZ   0}
if {![info exists last_TRANS]} {set last_TRANS $reset_TRANS}

#--- Calcula valores das variaveis do TRANS
set TXX    [expr ($mom_csys_matrix(0) * $mom_csys_origin(0)) + ($mom_csys_matrix(1) * $mom_csys_origin(1)) + ($mom_csys_matrix(2) * $mom_csys_origin(2))]
set TYY    [expr ($mom_csys_matrix(3) * $mom_csys_origin(0)) + ($mom_csys_matrix(4) * $mom_csys_origin(1)) + ($mom_csys_matrix(5) * $mom_csys_origin(2))]
set TZZ    [expr ($mom_csys_matrix(6) * $mom_csys_origin(0)) + ($mom_csys_matrix(7) * $mom_csys_origin(1)) + ($mom_csys_matrix(8) * $mom_csys_origin(2))]

#set TXX     $mom_csys_origin(0)
#set TYY     $mom_csys_origin(1)
#set TZZ     $mom_csys_origin(2)

set new_TRANS   "TRANS X[format %.3f $TXX] Y[format %.3f $TYY] Z[format %.3f [expr abs($TZZ)]]"
set new_CTRANS  "\$P_UIFR\[$mom_fixture_offset_value\]=CTRANS(X,[format %.3f $TXX],Y,[format %.3f $TYY],Z,[format %.3f $TZZ],B,0) ; G$usr_fixture_offset"
#set new_CTRANS  "\$P_UIFR\[$mom_fixture_offset_value\]=CTRANS(X,[format %.3f $mom_csys_origin(0)],Y,[format %.3f $mom_csys_origin(1)],Z,[format %.3f $mom_csys_origin(2)],B,0) ; G$usr_fixture_offset"


if {$tr_flag == 0} {
    if {$mom_csys_matrix(8) == 1 && $usr_fixture_offset == 54} {
        set out_line_0    $reset_TRANS
        set out_line        "!"
        set tr_flag    2
        #lappend g_lista $new_CTRANS
        #incr ii
        if {$init_trans == 0} {
            lappend g_lista $new_CTRANS
            set init_trans  1
            ...
            set out_line_0    "!"
            set out_line        $new_TRANS
            set tr_flag        1
            if {[lsearch -exact $g_lista $new_CTRANS] == -1} {
                lappend g_lista $new_CTRANS
                incr ii
            }
    }
} else {
    #--- Se mudou o MCS, gera novo TRANS
    if {$last_TXX != $TXX || $last_TYY != $TYY || $last_TZZ != $TZZ} {
        set out_line_0 $reset_TRANS
        set out_line   $new_TRANS
        set tr_flag    1
        if {[lsearch -exact $g_lista $new_CTRANS] == -1} {
...
# Define ultimo valor de TRANS
set  last_TXX        $TXX
set  last_TYY        $TYY
set  last_TZZ        $TZZ
set  last_TRANS      $new_TRANS

#MOM_force once G_motion X Y

#--- Verifica se está simulando
global flag_sim
if {![info exists flag_sim] || $flag_sim == 0} {
    set tr_flag    0
    return
}

if {$out_line_0    != "!"} {MOM_output_literal $out_line_0}
if {$out_line     != "!"} {MOM_output_literal $out_line}
}
...
#=============================================================
proc PB_CMD_usr_B_angle { } {
#=============================================================
global mom_init_pos  mom_out_angle_pos
global usr_B_angle   last_usr_B_angle
global mom_kin_coordinate_system_type

#--- Se não existir var "last_usr_B_angle", definir como "last_usr_B_angle" 0
if {![info exists usr_B_angle]} {
    set last_usr_B_angle    0
} else {set last_usr_B_angle    $usr_B_angle}


#--- Se não existir var "mom_init_pos", usar "mom_out_angle_pos"
if {![info exists mom_init_pos(3)]} {
    set usr_B_angle   [format %.3f $mom_out_angle_pos(0)]
} else {
        if {$mom_kin_coordinate_system_type == "LOCAL"} {set mom_init_pos(3)   0}
        set usr_B_angle    [expr [format %.3f $mom_init_pos(3)] + [format %.3f $mom_out_angle_pos(0)]]
}

# MOM_output_literal "==> init= $mom_init_pos(3) || out_ang= $mom_out_angle_pos(0)"
   ...
   set mom_pb_macro_arr(CYCLE82) \
       [list {CYCLE82 ( , ) 0 =} \
        {{{$mom_cycle_retract_to_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         ...
         {{$mom_cycle_feed_to_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         {} \
         {{$mom_cycle_delay} 1 3 3 1 1 6 3}}]

   set mom_pb_macro_arr(CYCLE90) \
       [list {CYCLE90 ( , ) 0 =} \
        {{{$mom_cycle_retract_to_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         {{$mom_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         {{$mom_cycle_rapid_to} 1 3 5 1 1 8 3} \
         {{$mom_cycle_feed_to_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         {} \
         {{$usr_diath} 1 3 4 1 1 7 3} \
         {{$usr_kdiath} 1 3 4 1 1 7 3} \
         {{$mom_cycle_feed_rate_per_rev} 1 3 3 1 1 6 3} \
         {{$feed} 1 3 5 1 1 8 3} \
         {{$usr_cdir} 1 3 3 1 1 6 3} \
         {{$usr_typth} 1 3 3 1 1 6 3} \
         {{$mom_cycle_rapid_to_pos(0)} 1 3 4 1 1 7 3} \
         {{$mom_cycle_rapid_to_pos(1)} 1 3 4 1 1 7 3}}]

   set mom_pb_macro_arr(CYCLE83) \
       [list {CYCLE83 ( , ) 0 =} \
        {{{$mom_cycle_retract_to_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         {{$mom_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         {{$mom_cycle_rapid_to} 1 3 5 1 1 8 3} \
         {{$mom_cycle_feed_to_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         {} \
         {{$usr_FDEP} 1 3 5 1 1 8 3} \
         {} \
         {{$usr_DAM} 1 3 3 1 1 6 3} \
         {{$usr_DTB} 1 3 3 1 1 6 3} \
         {{$usr_DTS} 1 3 3 1 1 6 3} \
         {{$usr_FRF} 1 3 3 1 1 6 3} \
         {{$usr_VARI} 1 0 3 0 0 3} \
         {{$usr_AXN} 1 3 3 1 1 6 3}}]
   ...
   set mom_pb_macro_arr(CYCLE84) \
       [list {CYCLE84 ( , ) 0 =} \
        {{{$mom_cycle_retract_to_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         ...
         {{$mom_cycle_feed_to_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         {} \
         {{$usr_DTB} 1 3 2 1 1 5 3} \
         {{$usr_SDAC} 1 0 2 0 0 2} \
         {} \
         {{$usr_PIT} 1 3 3 1 1 6 3} \
         {{$usr_POSS} 1 0 5 0 0 5} \
         {{$usr_SST} 1 3 4 1 1 7 3} \
         {{$usr_SST} 1 3 4 1 1 7 3}}]
   ...
   set mom_pb_macro_arr(CYCLE840) \
       [list {CYCLE840 ( , ) 0 =} \
        {{{$mom_cycle_retract_to_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         ...
         {{$usr_ENC} 1 0 2 0 0 2} \
         {} \
         {{$usr_PIT} 1 5 3 1 1 8 5} \
         {} \
         {{$usr_PTAB} 1 0 2 0 0 2}}]

   set mom_pb_macro_arr(CYCLE85) \
       [list {CYCLE85 ( , ) 0 =} \
        {{{$mom_cycle_retract_to_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         {{$mom_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         {{$mom_cycle_rapid_to} 1 3 5 1 1 8 3} \
         ...
         {} \
         {{$mom_cycle_delay} 1 3 3 1 1 6 3} \
         {{$usr_FFR} 1 3 5 1 1 8 3} \
         {{$usr_RFF} 1 3 5 1 1 8 3}}]
   ...
   set mom_pb_macro_arr(CYCLE86) \
       [list {CYCLE86 ( , ) 0 =} \
        {{{$mom_cycle_retract_to_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         ...
         {} \
         {{$mom_cycle_delay} 1 3 3 1 1 6 3} \
         {{$usr_SDIR} 1 4 3 0 0 3} \
         {{$usr_RPA} 1 3 5 1 1 8 3} \
         {{$usr_RPO} 1 3 5 1 1 8 3} \
         {{$usu_RPAP} 1 3 5 1 1 8 3} \
         {{$usr_POSS} 1 3 5 1 1 8 3}}]
