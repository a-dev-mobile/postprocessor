########################## TCL Event Handlers ##########################
#
#  DMG_DMC635V_ecoline_S840D_3e.tcl - 3_axis_mill
#
#    This is a 3-Axis Milling Machine.
#
#  Created by ronconi @ terça-feira, 9 de janeiro de 2018 12:52:22 E. South America Daylight Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "DMG_DMC635V_ecoline_S840D_3e__IN.pui"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   PB_CMD_usr_B_angle
   PB_CMD_retract_Z
   set rapid_spindle_blk {G_motion G_mode X Y Z D}
   set rapid_spindle_x_blk {G_motion G_mode X D}
   set rapid_spindle_y_blk {G_motion G_mode Y D}
   set rapid_spindle_z_blk {G_motion G_mode Z D}
   set rapid_traverse_blk {G_motion G_mode X Y Z D}
   set rapid_traverse_xy_blk {G_motion G_mode X Y D}
   set rapid_traverse_yz_blk {G_motion G_mode Y Z D}
   set rapid_traverse_xz_blk {G_motion G_mode X Z D}
   set rapid_traverse_mod {rapid1 rapid2}
   set rapid_spindle_mod {rapid3}
...
#=============================================================
   ...
   MOM_do_template auto_tool_change_8
...
global co ci  tr_flag
 ...
 MOM_output_literal "$co MAQUINA    : DMG DMC635V ecoline - COMANDO: SINUMERIK 840D $ci"
...
#==============================================================================
# 22/AGO/11    ---    WILLIAM       - Liberacao inicial para Unistamp, copia do Disc1250;
#                           - Del comandos Disc1250, add nome da ferramenta + HOME + G54;
#------------------------------------------------------------------------------
#
#
}
...
global co ci
 ...
 #MOM_output_literal "$co   $ci"
 MOM_output_literal "$co OPER.: $mom_path_name - FERR.: T$mom_tool_number $mom_tool_name $ci"
...
set filtro            "filtro1.tcl"



exec $aux_path$wishexe $std_customdir$filtro
}
   ...
   set mom_pb_macro_arr(CYCLE83) \
       [list {CYCLE83 ( , ) 0 =} \
        {{{$mom_cycle_retract_to_pos($mom_cycle_spindle_axis)} 1 3 5 1 1 8 3} \
         ...
         {{$usr_AXN} 1 4 3 1 1 7 4} \
         {} \
         {{$usr_VRT} 1 3 3 1 1 6 3} \
         {{$usr_DTD} 1 3 3 1 1 6 3} \
         {{$usr_DIS1} 1 3 3 1 1 6 3}}]
