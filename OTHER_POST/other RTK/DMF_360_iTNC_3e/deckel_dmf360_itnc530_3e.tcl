########################## TCL Event Handlers ##########################
#
#  deckel_dmf360_itnc530_3e.tcl -
#
#  Created by ronconi  @  Mon Dec 17 23:54:45 2007 E. South America Daylight Time
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   COOLANT_SET ; CUTCOM_SET ; SPINDLE_SET ; RAPID_SET
   PB_CMD_start_of_operation_force
   MOM_force Once Text G_motion Z M Text
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_motion X Y Z G_cutcom Text M_spindle}
   set rapid_traverse_xy_blk {G_motion X Y G_cutcom Text M_spindle}
   set rapid_traverse_yz_blk {G_motion Y Z G_cutcom Text M_spindle}
   set rapid_traverse_xz_blk {G_motion X Z G_cutcom Text M_spindle}
...
global co ci 
 ...
 MOM_output_literal "$co MAQUINA  : Deckel DMF360 - COMANDO: ITNC530 $ci"
...
#------------------------------------------------------------------------------
# 17/DEZ/07	 A	kleber		- DR+/DR- estava saindo após o F
