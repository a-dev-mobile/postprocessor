########################## TCL Event Handlers ##########################
#
#  fresadora_D-series_sinumerik_3e.tcl - 3_axis_mill
#
#    This is a 3-Axis Milling Machine.
#
#  Created by ronconi @ quarta-feira, 24 de maio de 2017 10:56:37 E. South America Standard Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "fresadora_D-series_sinumerik_3e__IN.pui"
...
set usr_partname     [lindex [split $mom_part_name "\\"] end]
 ...
 MOM_output_literal "$co\= MAQUINA    : D-SERIES - SINUMERIK - 3EIXOS $ci"
