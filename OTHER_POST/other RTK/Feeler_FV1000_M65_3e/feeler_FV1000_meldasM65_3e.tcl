########################## TCL Event Handlers ##########################
#
#  Created by ronconi  @  Mon Jul 17 15:14:53 2006 E. South America Daylight Time
...
#=============================================================
   ...
   MOM_set_seq_on
   PB_CMD_cabecalho
   MOM_force Once G_cutcom G_plane G_motion G_mode G
...
#=============================================================
 ...
 if {$mom_tool_axis(0) != 0} {
  ...
  set std_postdir 	[MOM_ask_env_var "UGII_CAM_POST_DIR"]
  set msg_window	"feeler_FV1300_meldasM65_4e_t_user.tcl"

  MOM_close_output_file $ptp_file_name

  if {![file exists $std_postdir$msg_window]} {MOM_abort "===> Arquivo $std_postdir$msg_window NAO ENCONTRADO!!"}

  #-- Chama Janela de Mensagem ----
  if {[catch {exec $aux_path$wishexe $std_postdir$msg_window} lixo]} { }
...
set tempo_anterior   0
 ...
 MOM_output_text "O$mom_output_file_basename"
 ...
 MOM_output_literal "$co MAQUINA  : FEELER FV1000 - COMANDO: MITSUBISHI MELDAS M65 $ci"
...
#==============================================================================
# 08/JUN/06	 -	Kleber		- Liberacao inicial
#------------------------------------------------------------------------------
#
#
#
...
if {[info exists start_flag]} {
    MOM_output_literal "M5"
} else { set start_flag	0}
}
...
#=============================================================
proc PB_CMD_verif_direcao_rotacao { } {
#=============================================================
global mom_spindle_direction usr_tap_code
...
#=============================================================
proc PB_CMD_verif_parametro_option { } {
#=============================================================
global cycle_code
global mom_cycle_option
 ...
 if {[info exists mom_cycle_option]} {
    if {$mom_cycle_option == "OPTION"} {set cycle_code 88}
 }
}
