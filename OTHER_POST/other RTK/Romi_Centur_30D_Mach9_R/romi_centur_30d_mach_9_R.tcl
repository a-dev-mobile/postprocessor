...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_output_file_suffix                "9C" 
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_min_arc_radius                    "0.05"
...
#=============================================================
   ...
   MOM_do_template tool_change_axis_preset
   MOM_force Once X Z
   MOM_do_template tool_change_axis_preset_1
...
# MOM_output_literal "$co MAQUINA  : TORNO ROMI CENTUR 30D - MACH 9 $ci"
...
#=============================================================
  ...
  if {$mom_spindle_mode == "SFM" || $mom_spindle_mode == "SMM"} {
     ...
     MOM_do_template spindle_rpm_preset_1
  }
}
