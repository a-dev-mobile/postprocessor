########################## TCL Event Handlers ##########################
#
#  Fadal_VMC_series_cnc88_4e.tcl - 4_axis_table
#
#    This is a 4-Axis Milling Machine With
#     Rotary Table.
#
#  Created by ronconi @ quinta-feira, 21 de dezembro de 2017 09:38:34 E. South America Daylight Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "Fadal_VMC_series_cnc88_4e__IN.pui"
...
#MOM_output_literal "$co DATA     : $mom_date   $ci"
 MOM_output_literal "$co MAQUINA  : FADAL VMC Series 4Eixos - COMANDO: FADAL $ci"
...
#==============================================================================
# 18/JAN/12    .00    William        - Liberacao inicial;
#------------------------------------------------------------------------------
#
}
...
#=============================================================
global ini_cycle_flag mom_prev_pos usr_Iplane

if {![info exists ini_cycle_flag]} {
    set usr_Iplane    $mom_prev_pos(2)
    set ini_cycle_flag    1
    MOM_force once cycle_Iplane F
}
}
...
#
   ...
   set ptp_file_name "${mom_output_file_directory}${mom_group_name}.${mom_sys_output_file_suffix}"
...
if {$cycle_flag == 0} {
    set cycle_flag    1
    MOM_force once X Y
    MOM_do_template cycle_coord_xy
}
}
