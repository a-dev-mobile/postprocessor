########################## TCL Event Handlers ##########################
#
#  Created by kleber  @  Fri Jul 15 13:44:00 2005 E. South America Daylight Time
...
#     source ${cam_debug_dir}mom_review.tcl
   ...
   ####  Listing File variables 
     ...
     set mom_sys_output_file_suffix                "pit"
...
#=============================================================
   ...
   MOM_set_seq_off
   PB_CMD_cabecalho
   MOM_force Once G_feed G_mode G_dwell
...
#=============================================================
   ...
   MOM_do_template coolant_off
   PB_CMD_verifica_from_point
   MOM_force Once G_feed G_motion X Z
   MOM_do_template tool_change_axis_preset
   MOM_force Once M_spindle M
...
set tempo_anterior   0
 ...
 MOM_output_literal "$co MAQUINA  : TORNO LOGIC MILENIUM - COMANDO: FAGOR 8055T $ci"
...
#=============================================================
proc PB_CMD_verifica_from_point { } {
#=============================================================
global mom_from_pos

if {$mom_from_pos(0) == 0} {set mom_from_pos(0)	200}
if {$mom_from_pos(2) == 0} {set mom_from_pos(2)	200}
