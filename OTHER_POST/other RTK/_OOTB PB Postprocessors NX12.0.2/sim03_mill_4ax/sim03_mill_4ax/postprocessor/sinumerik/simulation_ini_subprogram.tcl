...
#=============================================================
   ...
   foreach mcs $fixture_list {     
      #<lili 2013-06-03> Get matrix map from fixture offset MCS to main MCS
      set fixture_abs_matrix(0) $mom_mcs_info($mcs,xvec,0)
      set fixture_abs_matrix(1) $mom_mcs_info($mcs,xvec,1)
      set fixture_abs_matrix(2) $mom_mcs_info($mcs,xvec,2)
      set fixture_abs_matrix(3) $mom_mcs_info($mcs,yvec,0)
      set fixture_abs_matrix(4) $mom_mcs_info($mcs,yvec,1)
      set fixture_abs_matrix(5) $mom_mcs_info($mcs,yvec,2)
      set fixture_abs_matrix(6) $mom_mcs_info($mcs,zvec,0)
      set fixture_abs_matrix(7) $mom_mcs_info($mcs,zvec,1)
      set fixture_abs_matrix(8) $mom_mcs_info($mcs,zvec,2)
      
      MTX3_transpose main_mcs_matrix main_matrix_trns
      MTX3_multiply main_matrix_trns fixture_abs_matrix fixture_mcs_rotation
   
      # get rotation angle
      global dpp_fixture_rotation RAD2DEG
      set fixture_rot [expr -1*atan2($fixture_mcs_rotation(2), $fixture_mcs_rotation(0))]
      set dpp_fixture_rotation($mom_mcs_info($mcs,offset_val)) [expr $RAD2DEG*$fixture_rot]
      ...
      MTX3_vec_multiply origin_v main_mcs_matrix fixture_mcs_offset 

      #<lili 2013-06-03>
      MTX3_vec_multiply fixture_mcs_offset fixture_mcs_rotation temp_offset 
