########################## TCL Event Handlers ##########################
#
#  sim03_mill_4ax_sinumerik_in.tcl - 4_axis_table
#
#    This is a 4-Axis Milling Machine With
#     Rotary Table.
#
#  Created by lili @ Thursday, November 16, 2017 10:25:05 AM China Standard Time
...
# 20-Apr-2018 zhx   - PR9063633, PB_CMD_set_helix_move: when feed_distance = mom_helix_turn_number * abs(mom_helix_pitch), then mom_helix_turn_number should be decremented to 1
  ...
  set mom_sys_alt_unit_post_name                "sim03_mill_4ax_sinumerik_in__MM.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_home_pos(1)                       "24.272"
  set mom_sys_home_pos(2)                       "21.486"
  set mom_sys_zero                              "0"
