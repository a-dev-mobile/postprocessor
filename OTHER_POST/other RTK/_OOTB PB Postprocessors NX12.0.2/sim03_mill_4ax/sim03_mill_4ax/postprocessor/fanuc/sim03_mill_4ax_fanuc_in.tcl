########################## TCL Event Handlers ##########################
#
#  sim03_mill_4ax_fanuc_in.tcl - 4_axis_table
#
#    This is a 4-Axis Milling Machine With
#     Rotary Table.
#
#  Created by lili @ Thursday, November 16, 2017 10:24:35 AM China Standard Time
...
#                  PB_CMD_reset_output_mode, PB_CMD__check_block_cycle_plane_change_for_swiveling and PB_CMD_check_plane_change_for_swiveling.
  ...
  set mom_sys_alt_unit_post_name                "sim03_mill_4ax_fanuc_in__MM.pui"
...
#=============================================================
  ...
  global mom_cycle_clearance_plane_change
   ...
   if { [PB_CMD__check_block_cycle_plane_change_for_wcs_rotation] } {
      MOM_force Once fourth_axis G_motion
...
#=============================================================
  ...
  # Accumulated time should be in minutes.
   ...
   if { [PB_CMD__check_block_return_to_reference_point] } {
      MOM_force Once G_mode G53 G_motion fourth_axis
