########################## TCL Event Handlers ##########################
#
#  sim01_mill_3ax_fanuc_in.tcl - 3_axis_mill
#
#    This is a 3-Axis Milling Machine.
#
#  Created by lili @ Thursday, November 16, 2017 10:22:59 AM China Standard Time
...
#                  PB_CMD_reset_output_mode, PB_CMD__check_block_cycle_plane_change_for_swiveling and PB_CMD_check_plane_change_for_swiveling.
  ...
  set mom_sys_alt_unit_post_name                "sim01_mill_3ax_fanuc_in__MM.pui"
...
#=============================================================
  ...
  # Accumulated time should be in minutes.
   ...
   if { [PB_CMD__check_block_return_to_reference_point] } {
      MOM_force Once G_mode G53 G_motion
