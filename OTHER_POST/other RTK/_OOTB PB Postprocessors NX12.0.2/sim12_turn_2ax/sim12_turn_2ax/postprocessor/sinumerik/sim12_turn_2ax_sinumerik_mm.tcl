########################## TCL Event Handlers ##########################
#
#  sim12_turn_2ax_sinumerik_mm.tcl - lathe
#
#    This is a 2-Axis Horizontal Lathe Machine.
#
#  Created by lili @ Thursday, November 16, 2017 10:37:31 AM China Standard Time
...
# 07-Feb-2018 zhx - PR7602701 switch between G96 and G961 in Turning.
}
  ...
  set mom_sys_alt_unit_post_name                "sim12_turn_2ax_sinumerik_mm__IN.pui"
...
#   0 : No output
  ...
  #<2012-07-11 lili> enhance feed rate unit for NX8
...
# This command is used to calculate thread cycle parameters
 ...
 if {$cycle_name == "THREAD"} {
    ...
    if {[info exists mom_area_end_point_offset] && ![EQ_is_zero $mom_area_end_point_offset]} {
       set thread_end_pos(2) [expr $thread_end_pos(2)+$mom_area_end_point_offset]
    }
