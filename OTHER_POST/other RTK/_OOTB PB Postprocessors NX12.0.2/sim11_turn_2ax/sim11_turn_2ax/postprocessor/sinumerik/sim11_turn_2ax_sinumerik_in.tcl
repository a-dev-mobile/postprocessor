########################## TCL Event Handlers ##########################
#
#  sim11_turn_2ax_sinumerik_in.tcl - lathe
#
#    This is a 2-Axis Horizontal Lathe Machine.
#
#  Created by lili @ Thursday, November 16, 2017 10:37:16 AM China Standard Time
...
# 07-Feb-2018 zhx - PR7602701 switch between G96 and G961 in Turning
  ...
  set mom_sys_alt_unit_post_name                "sim11_turn_2ax_sinumerik_in__MM.pui"
...
#   0 : No output
   ...
   if { $mom_spindle_mode == "SFM" || $mom_spindle_mode == "SMM" } {
      if { ![info exists mom_spindle_maximum_rpm] ||  $mom_spindle_maximum_rpm == 0  } {
         ##<2013-5-2 Allen> Check if the Maximum limit is set in operation, if not a default value will be used and post will write warning message into listing window
