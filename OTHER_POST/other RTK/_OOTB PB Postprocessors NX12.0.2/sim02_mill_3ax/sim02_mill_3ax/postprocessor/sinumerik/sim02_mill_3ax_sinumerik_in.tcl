########################## TCL Event Handlers ##########################
#
#  sim02_mill_3ax_sinumerik_in.tcl - 3_axis_mill
#
#    This is a 3-Axis Milling Machine.
#
#  Created by lili @ Thursday, November 16, 2017 10:24:13 AM China Standard Time
...
# 20-Apr-2018 zhx   - PR9063633, PB_CMD_set_helix_move: when feed_distance = mom_helix_turn_number * abs(mom_helix_pitch), then mom_helix_turn_number should be decremented to 1
  ...
  set mom_sys_alt_unit_post_name                "sim02_mill_3ax_sinumerik_in__MM.pui"
