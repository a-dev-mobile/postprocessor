########################## TCL Event Handlers ##########################
#
#  sim14_mill_5ax_millplus_in.tcl - 5_axis_dual_table
#
#    This is a 5-Axis Milling Machine With
#     Dual Rotary Tables.
#
#  Created by lili @ Thursday, November 16, 2017 10:36:23 AM China Standard Time
...
#                  Replace MOM_abort with new MOM extension MOM_abort_program.
  ...
  set mom_sys_alt_unit_post_name                "sim14_mill_5ax_millplus_in__MM.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_cycle_bore_back_code              "790"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_4th_axis_max_limit                "3600000"
  set mom_kin_4th_axis_min_incr                 "0.001"
  set mom_kin_4th_axis_min_limit                "-3600000"
  ...
  set mom_kin_5th_axis_max_limit                "3600000"
  set mom_kin_5th_axis_min_incr                 "0.001"
  set mom_kin_5th_axis_min_limit                "-3600000"
...
#=============================================================
   ...
   MOM_do_template cycle_bore_drag_2
   set cycle_init_flag FALSE
}
...
#=============================================================
   ...
   MOM_do_template cycle_bore_dwell_2
   set cycle_init_flag FALSE
}
...
#=============================================================
   ...
   MOM_output_literal "(Warning!!! No cycle for this processing.)"
   set cycle_init_flag FALSE
}
...
#=============================================================
   ...
   MOM_do_template cycle_bore_no_drag_2
   set cycle_init_flag FALSE
}
...
#=============================================================
   ...
   MOM_do_template cycle_drill_deep_2
   set cycle_init_flag FALSE
}
...
#=============================================================
   ...
   MOM_do_template cycle_drill_dwell_2
   set cycle_init_flag FALSE
}
...
#=============================================================
  ...
  # Accumulated time should be in minutes.
   ...
   MOM_do_template g7_reset

   if { [PB_CMD__check_block_return_to_reference_point] } {
      MOM_force Once Z
      MOM_do_template g74_reset
   }

   if { [PB_CMD__check_block_return_to_reference_point] } {
      MOM_do_template return_home_B_C
   }
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   if { [PB_CMD__check_block_local_offset] } {
      MOM_do_template g93_offset
   }

   if { [PB_CMD__check_block_swiveling_coord_rot] } {
      MOM_do_template g7_setting
   }

   if { [PB_CMD__check_block_G141_output] } {
...
#=============================================================
   ...
   PB_CMD_mp_set_tool_adjust_register

   if { [PB_CMD__check_block_tool_info_output] } {
      MOM_do_template start_of_path
   }

   MOM_force Once S T M
...
#=============================================================
   ...
   MOM_do_template tool_radius_adjust_cancel

   MOM_do_template g17

   MOM_do_template g7_reset

   MOM_do_template output_world_csys
...
#=============================================================
proc PB_CMD__check_block_G141_output { } {
#=============================================================
...
return 0
  ...
  MOM_force Once tap_string F dwell cycle_step
return 1
  }
}
...
#=============================================================
proc PB_CMD__check_block_cycle_drill { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
...
global dpp_mp_prev_cycle_feed_to
global dpp_mp_prev_cycle_delay
global dpp_mp_prev_clearance_plane
global dpp_mp_prev_retract_to

  if { ![info exists dpp_mp_prev_cycle_feed_to] ||
       ![info exists dpp_mp_prev_cycle_delay] ||
       ![info exists dpp_mp_prev_clearance_plane] ||
       ![info exists dpp_mp_prev_retract_to] } {
     set dpp_mp_prev_cycle_feed_to $mom_cycle_feed_to
     set dpp_mp_prev_cycle_delay $mom_cycle_delay
     set dpp_mp_prev_clearance_plane $mom_cycle_clearance_plane
     set dpp_mp_prev_retract_to $mom_cycle_retract_to
     return 1
  } else {
     if { ![EQ_is_equal $dpp_mp_prev_cycle_feed_to  $mom_cycle_feed_to] ||
          ![EQ_is_equal $dpp_mp_prev_cycle_delay  $mom_cycle_delay] ||
          ![EQ_is_equal $dpp_mp_prev_clearance_plane  $mom_cycle_clearance_plane] ||
          ![EQ_is_equal $dpp_mp_prev_retract_to  $mom_cycle_retract_to] } {
        set dpp_mp_prev_cycle_feed_to $mom_cycle_feed_to
        set dpp_mp_prev_cycle_delay $mom_cycle_delay
        set dpp_mp_prev_clearance_plane $mom_cycle_clearance_plane
        set dpp_mp_prev_retract_to $mom_cycle_retract_to
...
# Check if tool axis changes between hole.
# When tool axis change back to Z axis, recalculate mom_pos using the original kinematics.
...
# set default value for flag variable dpp_ge(cycle_plane_change)
  ...
  if {$dpp_ge(toolpath_axis_num)=="3"} {
     set dpp_ge(coord_rot) [DPP_GE_COOR_ROT "ZYX" angle offset pos]
     for {set i 0} {$i<3} {incr i} {
        ...
        if {[info exists angle]} {
           set j [expr 2-$i]
           set dpp_ge(coord_rot_angle,$i) $angle($j)
        }
        if {[info exists pos]} {
           set mom_pos($i) $pos($i)
        }
     ...
     if {[string compare "NONE" $dpp_ge(coord_rot)]} {
        if {![EQ_is_equal $dpp_ge(coord_rot_angle,0) $dpp_ge(prev_coord_rot_angle,0)] ||\
           ...
           set dpp_mp_surface_plane $mom_pos(2)
...
#=============================================================
proc PB_CMD__check_block_initial_move_XY { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
...
#=============================================================
proc PB_CMD__check_block_local_offset { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
...
#=============================================================
proc PB_CMD__check_block_next_tool { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
# Check if there is next tool or if current operation is the last operation.
...
#=============================================================
proc PB_CMD__check_block_return_home_B_C { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
...
#
# 2014-07-22 Jason - Initial version.
...
#=============================================================
proc PB_CMD__check_block_tool_info_output { } {
#=============================================================
# This custom command should return
#   1 : Output BLOCK
#   0 : No output
   ...
   set mom_tool_diameter [format "%.2f" $mom_tool_diameter]
...
# 10-18-2013 levi - When tool axis change back to straight in 3+2 operation, recalculate mom_pos using the original kinematics.
  ...
  if {[string match "*3_axis*" $save_mom_kin_machine_type] ||\
      [string match "*4_axis*" $save_mom_kin_machine_type] ||\
      $dpp_ge(coord_rot) == "LOCAL" } {
     return
  }
     ...
     if {![EQ_is_equal $mom_out_angle_pos(0) $mom_prev_out_angle_pos(0)] || \
        ...
        if {[string compare "NONE" $dpp_ge(coord_rot)]} {
           if {![EQ_is_equal $dpp_ge(coord_rot_angle,0) $dpp_ge(prev_coord_rot_angle,0)] ||\
              ...
              MOM_enable_address fourth_axis fifth_axis
              MOM_force once G_adjust X Y Z fourth_axis fifth_axis
...
# 04-15-2014 Jintao -  PR7162261, in new drilling operation, mom_retract_to_pos(mom_last_pos) is always in a higher position
# than clearance pos, we don't need to do anything
   ...
   if {$mom_cycle_tool_axis_change ==0 && $mom_cycle_clearance_plane_change == 1 && \
       $dpp_ge(cycle_hole_counter)!=0 && [EQ_is_lt $mom_last_pos(2) $mom_cycle_clearance_pos(2)] } {
      MOM_force Once G_motion
      MOM_do_template rapid_move_Z_in_cycle
      MOM_force Once G_motion tap_string X Y Z F R dwell cycle_step
   } elseif {$mom_cycle_tool_axis_change ==0 && $mom_cycle_clearance_plane_change == -1 && $dpp_ge(cycle_hole_counter)!=0} {
      MOM_force Once G_motion
      MOM_do_template rapid_move_XY_in_cycle
      MOM_force Once G_motion tap_string X Y Z F R dwell cycle_step
   }
}
  ...
  if {[string compare "NONE" $dpp_ge(coord_rot)]} {
        ...
        for {set i 0} {$i<3} {incr i} {
           ...
           if {[info exists angle]} {
              set j [expr 2-$i]
              set dpp_ge(coord_rot_angle,$i) $angle($j)
              set dpp_ge(prev_coord_rot_angle,$i) $angle($j)
           }
           if {[info exists pos]} {
              set mom_pos($i) $pos($i)
           }
...
#=============================================================
  ...
  global mom_cycle_clearance_plane
  global dpp_mp_cycle_retract_to
  global dpp_mp_surface_plane
  global mom_pos
  global dpp_ge
...
# set mom_cycle_retract_to a incremental value
  if { [info exists cycle_init_flag] && [string match "TRUE" $cycle_init_flag] } {
     set dpp_mp_cycle_retract_to [expr $mom_cycle_retract_to - $mom_cycle_clearance_plane]
  } else {
     if { ![info exists dpp_mp_cycle_retract_to] } {
     set dpp_mp_cycle_retract_to [expr $mom_cycle_retract_to - $mom_cycle_clearance_plane]
     }
  }
# set the drilling surface plane
  set dpp_ge(coord_rot) [DPP_GE_COOR_ROT "ZYX" angle offset pos]
  if {![string compare "NONE" $dpp_ge(coord_rot)]} {
     set dpp_mp_surface_plane $mom_pos(2)
  } else {
     set dpp_mp_surface_plane $pos(2)
  }
}
...
MOM_force once G_mode G_adjust X Y Z
...
# 27-04-15 Lili  - Fix drilling cycle issue in PB_CMD_set_cycle_plane_change.
#                - Enhance opertion type detect in DPP_GE_DETECT_HOLE_CUTTING_OPERATION.
}


#=============================================================
proc PB_CMD_mp_set_tool_adjust_register { } {
#=============================================================
  global dpp_mp_tool_adjust_register
  global mom_tool_adjust_register
  global mom_tool_adjust_register_defined

  if {$mom_tool_adjust_register_defined == 1 && $mom_tool_adjust_register >= 1} {
     set dpp_mp_tool_adjust_register $mom_tool_adjust_register
     MOM_force ONCE T2
  } else {
     set dpp_mp_tool_adjust_register 1
     MOM_force ONCE T2
  }
...
#=============================================================
  ...
  if { $mom_feed_approach_value > 0 } {
    set mom_feed_approach_unit [string toupper $mom_feed_approach_unit]
    if { $mom_feed_approach_unit == "MMPM" } {
      set feed $mom_feed_approach_value
    } elseif { $mom_feed_approach_unit == "MMPR" } {
      set feed [expr $mom_feed_approach_value * $mom_spindle_rpm]
    }
  } elseif { $mom_feed_cut_value > 0 } {
    set mom_feed_cut_unit [string toupper $mom_feed_cut_unit]
    if { $mom_feed_cut_unit == "MMPM" } {
      set feed $mom_feed_cut_value
    } elseif { $mom_feed_cut_unit == "MMPR" } {
      set feed [expr $mom_feed_cut_value * $mom_spindle_rpm]
    }
  } elseif { $mom_feed_engage_value > 0 } {
    set mom_feed_engage_unit [string toupper $mom_feed_engage_unit]
    if { $mom_feed_engage_unit == "MMPM" } {
      set feed $mom_feed_engage_value
    } elseif { $mom_feed_engage_unit == "MMPR" } {
      set feed [expr $mom_feed_engage_value * $mom_spindle_rpm]
    }
  } elseif { $mom_feed_first_cut_value > 0 } {
    set mom_feed_first_cut_unit [string toupper $mom_feed_first_cut_unit]
    if { $mom_feed_first_cut_unit == "MMPM" } {
      set feed $mom_feed_first_cut_value
    } elseif { $mom_feed_first_cut_unit == "MMPR" } {
      set feed [expr $mom_feed_first_cut_value * $mom_spindle_rpm]
    }
  }

  if { $mom_cycle_status == "ON" || $mom_cycle_status == "SAME"} {
    set mom_cycle_feed_rate_mode [string toupper $mom_cycle_feed_rate_mode]
    if { $mom_cycle_feed_rate_mode == "MMPR" } {
      if { $mom_cycle_feed_rate_per_rev > 0  && $mom_spindle_rpm > 0 } {
        set feed [expr $mom_cycle_feed_rate_per_rev * $mom_spindle_rpm ]
      }
    } elseif { $mom_cycle_feed_rate_mode == "MMPM" } {
      if { $mom_cycle_feed_rate > 0 } {
...
#
#  If there is no attribute assigned to the program group, the string N0001
...
#
   ...
   if { ![info exists mom_attr_PROGRAMVIEW_PROGRAM_NUMBER] } {
      set mom_attr_PROGRAMVIEW_PROGRAM_NUMBER "N0001"
   }
...
MOM_output_literal "mom_cycle_rapid_to_pos(2)=$mom_cycle_rapid_to_pos(2)"
        }
     }
  }
}
...
#=============================================================
# Determine the tapping G code according to thread direction
#
...
# If the thread direction is different with spindle rotary direction, pop up warning message
  if {([info exists mom_cycle_thread_right_handed] && $mom_cycle_thread_right_handed == TRUE && $mom_spindle_direction == "CCLW") ||\
      ([info exists mom_cycle_thread_right_handed] && $mom_cycle_thread_right_handed == FALSE && $mom_spindle_direction == "CLW")} {
     PAUSE "Spindle rotary direction is wrong!"
