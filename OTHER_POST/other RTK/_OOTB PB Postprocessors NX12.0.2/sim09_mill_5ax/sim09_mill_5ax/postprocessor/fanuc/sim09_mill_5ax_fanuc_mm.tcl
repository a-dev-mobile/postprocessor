########################## TCL Event Handlers ##########################
#
#  sim09_mill_5ax_fanuc_mm.tcl - 5_axis_head_table
#
#    This is a 5-Axis Milling Machine With
#     Rotary Head and Table.
#
#  Created by lili @ Thursday, November 16, 2017 10:30:27 AM China Standard Time
...
# 03-30-2016 lili - Updated PB_CMD__check_block_output_rotary_before PB_CMD_customize_output_mode for sim09 head.
...
#                  PB_CMD_reset_output_mode, PB_CMD__check_block_cycle_plane_change_for_swiveling and PB_CMD_check_plane_change_for_swiveling.
  ...
  set mom_sys_alt_unit_post_name                "sim09_mill_5ax_fanuc_mm__IN.pui"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_5th_axis_max_limit                "36000"
  set mom_kin_5th_axis_min_incr                 "0.001"
  set mom_kin_5th_axis_min_limit                "-36000"
...
# 03-30-2016 lili - Don't output rotary angles for sim09 head
  ...
  #<lili 03-30-2016> Don't output rotary angles for head, current rotary angle value is not correct.
...
# 03-30-2016 lili - set output mode to "VECTOR" for sim09 head
