########################## TCL Event Handlers ##########################
#
#  sim09_mill_5ax_tnc_mm.tcl - 5_axis_head_table
#
#    This is a 5-Axis Milling Machine With
#     Rotary Head and Table.
#
#  Created by lili @ Thursday, November 16, 2017 10:30:40 AM China Standard Time
...
# 03-29-2016 szl - Updated PB_CMD__check_block_spindle_on. Update mom_coolant_mode if operation doesn't attach UDE, otherwise it won't work in turbo mode.
#                  Updated MOM_coolant_on. Output M_coolant code when coolant_on UDE is activated for operations.
# 03-30-2016 lili - Updated PB_CMD__check_block_vector PB_CMD_customize_output_mode PB_CMD_reset_output_mode to correct output mode of TX TY TZ. Set sim09 5axisoutput mode to "VECTOR"
...
# 08-22-2016 szl - Add M_spindle word in linear_move_2 block.
...
# 09-30-2016 lili - Set 5axis mode to "AXIS"
...
#                  PB_CMD_customize_output_mode, PB_CMD_reset_output_mode, PB_CMD_cycle_coord_rotation and PB_CMD_check_plane_change_in_rapid_move.
  ...
  set mom_sys_alt_unit_post_name                "sim09_mill_5ax_tnc_mm__IN.pui"
...
# 30-Nov-17 zhx    - fix PR8951511 drilling operation issue
...
# 2. set coolant on as default for OOTB Kits unless the operation type is Deep Hole Drilling
#
...
#   0 : No output
#
# <lili 03-30-2016> force output of XYZ
   ...
   if {[info exists mom_output_mode_define] && $mom_output_mode_define != "ROTARY AXES"} {
      ...
      #<lili 03-30-2016> Force output of XYZ for tool axis vector output.
      MOM_force Once X Y Z
 return 1
   } else {
 return 0
...
# mom_output_mode_define
  # Descriptions: Devine the output mode of rotary axes
   # ROTRARY AXES: output rotary axes as A B C
   # VECTOR: Output tool axis vector as TX TY TZ

# 06-18-2013 Jason - Initial version
# 03-30-2016 lili - Add mom_output_mode_define
  ...
  #set mom_output_mode_define "VECTOR"
...
#
# 06-18-2013 Jason - Initial version
# 03-30-2016 lili  - Remove unset of mom_output_mode_define
...
#Cancel M128
  ...
  #<lili 03-30-2016> comment out following unset of mom_output_mode_define
