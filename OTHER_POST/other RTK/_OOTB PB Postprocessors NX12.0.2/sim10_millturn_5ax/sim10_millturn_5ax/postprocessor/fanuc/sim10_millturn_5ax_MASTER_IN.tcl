########################## TCL Event Handlers ##########################
#
#  sim10_millturn_5ax_MASTER_IN.tcl - 3_axis_mill_turn
#
#    3-Axis Mill-Turn (XZC)
#
#  Created by w5ygvn @ Friday, March 03, 2017 2:13:25 PM China Standard Time
...
# 01-06-2017 szl - Resaved with PB v11.0.1.
  ...
  set mom_sys_alt_unit_post_name                "sim10_millturn_5ax_MASTER_IN__MM.pui"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_x_axis_limit                      "8.1"
  set mom_kin_y_axis_limit                      "50"
  set mom_kin_z_axis_limit                      "22.8"
...
#=========================
 ...
 set mom_sys_postname(QUIL)                    "xzc_millturn_quil_IN"
 set mom_sys_postname(MILL_X)                  "xzc_millturn_mill_x_IN"
 set mom_sys_postname(TURN)                    "xzc_millturn_turn_IN"
...
#=============================================================
proc PB_start_of_HEAD__MILL_LOWER_SUB { } {
#=============================================================
}
...
#=============================================================
   PB_CMD_turn_lower_sub
}


#=============================================================
proc PB_start_of_HEAD__TURN_LOWER_SUB { } {
#=============================================================
}
...
#=============================================================
   ...
   MOM_force Once F X Z fourth_axis R
...
#=============================================================
   MOM_force Once G_motion X
   MOM_do_template gohome_move

   MOM_force Once G
   MOM_do_template home_x_axis_g28

   MOM_force Once G
   MOM_do_template home_z_axis_g28
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_motion G_mode X Y Z fourth_axis}
   set rapid_spindle_x_blk {G_motion G_mode X fourth_axis}
   set rapid_spindle_y_blk {G_motion G_mode Y fourth_axis}
   set rapid_spindle_z_blk {G_motion G_mode Z fourth_axis}
   set rapid_traverse_blk {G_motion G_mode X Y Z fourth_axis M_spindle M_coolant}
   set rapid_traverse_xy_blk {G_motion G_mode X Y fourth_axis M_spindle M_coolant}
   set rapid_traverse_yz_blk {G_motion G_mode Y Z fourth_axis M_spindle M_coolant}
   set rapid_traverse_xz_blk {G_motion G_mode X Z fourth_axis M_spindle M_coolant}
...
#=============================================================
   MOM_do_template spindle_main_off
}
...
#=============================================================
  ...
  global mom_sys_machine_time mom_machine_time
   ...
   MOM_force Once G_cutcom G_feed G_motion
...
#=============================================================
   ...
   MOM_do_template coordinate_select
...
#=============================================================
proc PB_CMD_cycle_param_set { } {
#=============================================================
global initial_cycle_pos
global cycle_rapid_distance
global mom_cycle_rapid_to_pos
global mom_cycle_feed_to_pos
global cycle_feed_distance
...
set cycle_rapid_distance [expr $mom_cycle_rapid_to_pos($mom_cycle_spindle_axis) - $initial_cycle_pos($mom_cycle_spindle_axis)]
set mom_cycle_feed_to_pos($mom_cycle_spindle_axis) [expr $mom_cycle_feed_to_pos($mom_cycle_spindle_axis) - $mom_cycle_rapid_to_pos($mom_cycle_spindle_axis)]
}
...
#=============================================================
proc PB_CMD_init_combine_rotary { } {
#=============================================================
...
#=============================================================
proc PB_CMD_mill_lower_sub { } {
#=============================================================
global mom_sys_spindle_direction_code
set mom_sys_spindle_direction_code(OFF) 135
}
...
if { [string match O* $mom_attr_PROGRAMVIEW_PROGRAM_NUMBER ] } {
...
MOM_do_template cartesian_mode
}
...
global mom_sys_coordinate_calculation_method
   ...
   if { $mom_coordinate_output_mode == "C-AXIS MILL ROTARY INTERPOLATE" && $mom_sys_coordinate_calculation_method == "CARTESIAN" } {
      if { $mom_sys_output_mode != "G112" } {
        ...
        # G112 X C(Y) Z mode.
        #  Mazatrol T32 Compatible Mode uses Y
...
#=============================================================
proc PB_CMD_turn_lower_sub { } {
#=============================================================
global mom_head_name
global mom_sys_spindle_direction_code

if { $mom_head_name == "TURN_LOWER_SUB" } {
   set mom_sys_spindle_direction_code(CLW)  103
   set mom_sys_spindle_direction_code(CCLW) 104
   set mom_sys_spindle_direction_code(OFF) 105
}
}
