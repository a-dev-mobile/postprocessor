########################## TCL Event Handlers ##########################
#
#  sim10_millturn_5ax_MASTER_mm.tcl - 3_axis_mill_turn
#
#    3-Axis Mill-Turn (XZC)
#
#  Created by w5ygvn @ Friday, March 03, 2017 2:13:27 PM China Standard Time
...
# 01-06-2017 szl - Resaved with PB v11.0.1.
  ...
  set mom_sys_alt_unit_post_name                "sim10_millturn_5ax_MASTER_mm__IN.pui"
...
#=========================
 ...
 set mom_sys_postname(QUIL)                    "xzc_millturn_quil_mm"
 set mom_sys_postname(MILL_X)                  "xzc_millturn_mill_x_mm"
 set mom_sys_postname(TURN)                    "xzc_millturn_turn_mm"
...
#=============================================================
   ...
   MOM_force Once fourth_axis R X F Z
...
#=============================================================
   ...
   MOM_do_template spindle_live_tool_off
}
