########################## TCL Event Handlers ##########################
#
#  sim05_mill_5ax_fanuc_in.tcl - 5_axis_dual_head
#
#    This is a 5-Axis Milling Machine With
#     Dual Rotary Heads.
#
#  Created by lili @ Thursday, November 16, 2017 10:26:23 AM China Standard Time
...
# 12-22-2015 szl - Add PB_CMD__check_block_coolant_off to enhance back counter sinking and deep hole drilling.
...
# 03-29-2016 szl - Updated PB_CMD__check_block_coolant_off. Update mom_coolant_mode if operation doesn't attach UDE, otherwise it won't work in turbo mode.
...
#                  PB_CMD_reset_output_mode, PB_CMD__check_block_cycle_plane_change_for_swiveling and PB_CMD_check_plane_change_for_swiveling.
  ...
  set mom_sys_alt_unit_post_name                "sim05_mill_5ax_fanuc_in__MM.pui"
...
return
   ...
   puts $tmp_file "      MAX         9999 Truncate"
   puts $tmp_file "      MIN         -9999 Truncate"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_bore_no_drag"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_cycle_bore_no_drag_code\]"
   ...
   puts $tmp_file "      fourth_axis\[\$mom_out_angle_pos(0)\]"
   puts $tmp_file "      H\[\$mom_tool_adjust_register\]"
   puts $tmp_file "      F\[\$feed\]"
   puts $tmp_file "      R\[\$mom_cycle_rapid_to_pos(\$mom_cycle_spindle_axis)\]"
   puts $tmp_file "      cycle_orient\[\$mom_cycle_orient\]\\opt"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_tap_float"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      tap_string\[\$final_tap_mode\]"
   puts $tmp_file "      G_adjust\[\$mom_sys_adjust_code\]"
   puts $tmp_file "      X\[\$mom_cycle_feed_to_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_cycle_feed_to_pos(1)\]"
   puts $tmp_file "      Z\[\$mom_cycle_feed_to_pos(2)\]"
   ...
   puts $tmp_file "      F\[\$feed\]"
   puts $tmp_file "      R\[\$mom_cycle_rapid_to_pos(\$mom_cycle_spindle_axis)\]"
   puts $tmp_file "      cycle_dwell\[\$mom_cycle_delay\]\\opt"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_tap_deep"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      tap_string\[\$final_tap_mode\]"
   ...
   puts $tmp_file "      R\[\$mom_cycle_rapid_to_pos(\$mom_cycle_spindle_axis)\]"
   puts $tmp_file "      cycle_dwell\[\$mom_cycle_delay\]\\opt"
   puts $tmp_file "      cycle_step\[\$mom_cycle_step1\]"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   ...
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   puts $tmp_file "      G_adjust\[\$mom_sys_adjust_code\]\\opt"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_tap_break_chip"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      tap_string\[\$final_tap_mode\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE initial_move_BC"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   puts $tmp_file "      fifth_axis\[\$mom_out_angle_pos(1)\]"
   puts $tmp_file "      fourth_axis\[\$mom_out_angle_pos(0)\]"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_bore_manual"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_cycle_bore_manual_code\]"
   puts $tmp_file "      G_adjust\[\$mom_sys_adjust_code\]"
   puts $tmp_file "      X\[\$mom_cycle_feed_to_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_cycle_feed_to_pos(1)\]"
   puts $tmp_file "      Z\[\$mom_cycle_feed_to_pos(2)\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE return_rotary_axis_to_zero"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_mode\[\$mom_sys_output_code(ABSOLUTE)\]"
   puts $tmp_file "      G53\[53\]"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   puts $tmp_file "      fifth_axis\[0\]"
   puts $tmp_file "      fourth_axis\[0\]"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE default_linear_move"
   puts $tmp_file "  \{"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_tap_3"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      tap_string\[\$final_tap_mode\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_bore_dwell"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_cycle_bore_dwell_code\]"
   puts $tmp_file "      G_adjust\[\$mom_sys_adjust_code\]"
   puts $tmp_file "      X\[\$mom_cycle_feed_to_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_cycle_feed_to_pos(1)\]"
   puts $tmp_file "      Z\[\$mom_cycle_feed_to_pos(2)\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_drill"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_cycle_drill_code\]"
   puts $tmp_file "      G_adjust\[\$mom_sys_adjust_code\]"
   puts $tmp_file "      X\[\$mom_cycle_feed_to_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_cycle_feed_to_pos(1)\]"
   puts $tmp_file "      Z\[\$mom_cycle_feed_to_pos(2)\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE tap_deep_break_chip_move"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      tap_string\[\$final_tap_mode\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE tap_3"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      tap_string\[\$final_tap_mode\]"
   puts $tmp_file "      G_adjust\[\$mom_sys_adjust_code\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE reset_rotary_axis"
   puts $tmp_file "  \{"
   puts $tmp_file "      fifth_axis\[0\]"
   puts $tmp_file "      fourth_axis\[0\]"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE initial_move_rotation"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   puts $tmp_file "      fifth_axis\[\$mom_out_angle_pos(1)\]"
   puts $tmp_file "      fourth_axis\[\$mom_out_angle_pos(0)\]"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE init_move_xybc"
   puts $tmp_file "  \{"
   puts $tmp_file "      X\[\$mom_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_pos(1)\]"
   puts $tmp_file "      fifth_axis\[\$mom_out_angle_pos(1)\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_tap_4"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      tap_string\[\$final_tap_mode\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE three_plus_two_suppress"
   puts $tmp_file "  \{"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE initial_move_2"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   puts $tmp_file "      fifth_axis\[\$mom_out_angle_pos(1)\]"
   puts $tmp_file "      fourth_axis\[\$mom_out_angle_pos(0)\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE hpcc_mode_1"
   puts $tmp_file "  \{"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE initial_move_XYFBC"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_mode\[\$mom_sys_output_code(\$mom_output_mode)\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   puts $tmp_file "      X\[\$mom_pos(0)\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_bore_manual_dwell"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_cycle_bore_manual_dwell_code\]"
   puts $tmp_file "      G_adjust\[\$mom_sys_adjust_code\]"
   puts $tmp_file "      X\[\$mom_cycle_feed_to_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_cycle_feed_to_pos(1)\]"
   puts $tmp_file "      Z\[\$mom_cycle_feed_to_pos(2)\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_drill_deep"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_cycle_drill_deep_code\]"
   puts $tmp_file "      G_adjust\[\$mom_sys_adjust_code\]"
   puts $tmp_file "      X\[\$mom_cycle_feed_to_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_cycle_feed_to_pos(1)\]"
   puts $tmp_file "      Z\[\$mom_cycle_feed_to_pos(2)\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_tap"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      tap_string\[\$final_tap_mode\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_bore_drag"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_cycle_bore_drag_code\]"
   puts $tmp_file "      G_adjust\[\$mom_sys_adjust_code\]"
   puts $tmp_file "      X\[\$mom_cycle_feed_to_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_cycle_feed_to_pos(1)\]"
   puts $tmp_file "      Z\[\$mom_cycle_feed_to_pos(2)\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_drill_break_chip"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_cycle_drill_break_chip_code\]"
   puts $tmp_file "      G_adjust\[\$mom_sys_adjust_code\]"
   puts $tmp_file "      X\[\$mom_cycle_feed_to_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_cycle_feed_to_pos(1)\]"
   puts $tmp_file "      Z\[\$mom_cycle_feed_to_pos(2)\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_drill_dwell"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_cycle_drill_dwell_code\]"
   puts $tmp_file "      G_adjust\[\$mom_sys_adjust_code\]"
   puts $tmp_file "      X\[\$mom_cycle_feed_to_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_cycle_feed_to_pos(1)\]"
   puts $tmp_file "      Z\[\$mom_cycle_feed_to_pos(2)\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_plane_change_2"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_motion\[\$mom_sys_rapid_code\]"
   puts $tmp_file "      fifth_axis\[\$mom_out_angle_pos(1)\]"
   puts $tmp_file "      fourth_axis\[\$mom_out_angle_pos(0)\]"
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_bore"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_cycle_bore_code\]"
   puts $tmp_file "      G_adjust\[\$mom_sys_adjust_code\]"
   puts $tmp_file "      X\[\$mom_cycle_feed_to_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_cycle_feed_to_pos(1)\]"
   puts $tmp_file "      Z\[\$mom_cycle_feed_to_pos(2)\]"
   ...
   puts $tmp_file "  \}"
   puts $tmp_file ""
   puts $tmp_file "  BLOCK_TEMPLATE cycle_bore_back"
   puts $tmp_file "  \{"
   puts $tmp_file "      G_feed\[\$mom_sys_feed_rate_mode_code(\$feed_mode)\]\\opt"
   puts $tmp_file "      G_return\[\$mom_sys_cycle_ret_code(\$mom_cycle_retract_mode)\]\\opt"
   puts $tmp_file "      G_motion\[\$mom_sys_cycle_bore_back_code\]"
   puts $tmp_file "      G_adjust\[\$mom_sys_adjust_code\]"
   puts $tmp_file "      X\[\$mom_cycle_feed_to_pos(0)\]"
   puts $tmp_file "      Y\[\$mom_cycle_feed_to_pos(1)\]"
   puts $tmp_file "      Z\[\$mom_cycle_feed_to_pos(2)\]"
...
#=============================================================
  ...
  global mom_cycle_clearance_plane_change
   ...
   if { [PB_CMD__check_block_cycle_plane_change_for_wcs_rotation] } {
      MOM_force Once fourth_axis fifth_axis G_motion
   ...
   if { [PB_CMD__check_block_position_after_cycle_plane_change] } {
      MOM_force Once G_motion X Y Z G_adjust H
...
#                 - Bug fix: Check on "detect work plane change to lower" in cycle plane change.
# 06-04-2014 Allen - PR7143300 fix: check if variable mom_next_oper_has_tool_change and mom_current_oper_is_last_oper_in_program exists for PB_CMD__check_block_return_to_reference_point
# 12-04-14 Lili  - Enhance the warning message when users set wrong pitch and wrong spindle speed.
