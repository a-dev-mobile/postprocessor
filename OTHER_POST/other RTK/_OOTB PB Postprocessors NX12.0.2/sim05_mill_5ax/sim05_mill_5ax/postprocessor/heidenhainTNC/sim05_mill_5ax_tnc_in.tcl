########################## TCL Event Handlers ##########################
#
#  sim05_mill_5ax_tnc_in.tcl - 5_axis_dual_head
#
#    This is a 5-Axis Milling Machine With
#     Dual Rotary Heads.
#
#  Created by lili @ Thursday, November 16, 2017 10:26:41 AM China Standard Time
...
#                  PB_CMD_customize_output_mode, PB_CMD_reset_output_mode, PB_CMD_cycle_coord_rotation and PB_CMD_check_plane_change_in_rapid_move.
  ...
  set mom_sys_alt_unit_post_name                "sim05_mill_5ax_tnc_in__MM.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_home_pos(0)                       "40"
  set mom_sys_home_pos(1)                       "-40"
  set mom_sys_home_pos(2)                       "35"
  set mom_sys_zero                              "0"
