########################## TCL Event Handlers ##########################
#
#  sim05_mill_5ax_sinumerik_mm.tcl - 5_axis_dual_head
#
#    This is a 5-Axis Milling Machine With
#     Dual Rotary Heads.
#
#  Created by lili @ Thursday, November 16, 2017 10:27:28 AM China Standard Time
...
# 26-Apr-2017 szl   - Update PB_CMD__check_block_rotation_axes, regression fix(PR8816483) for sim03_tombstone: the fixture cannot get the correct rotation angle.
  ...
  set mom_sys_alt_unit_post_name                "sim05_mill_5ax_sinumerik_mm__IN.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_home_pos(0)                       "998"
  set mom_sys_home_pos(1)                       "-800"
  set mom_sys_home_pos(2)                       "698.5"
  set mom_sys_zero                              "0"
