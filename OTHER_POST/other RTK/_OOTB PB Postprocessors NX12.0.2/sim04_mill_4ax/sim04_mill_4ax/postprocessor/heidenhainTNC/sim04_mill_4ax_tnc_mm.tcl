########################## TCL Event Handlers ##########################
#
#  sim04_mill_4ax_tnc_mm.tcl - 4_axis_table
#
#    This is a 4-Axis Milling Machine With
#     Rotary Table.
#
#  Created by lili @ Thursday, November 16, 2017 10:25:48 AM China Standard Time
...
#                  PB_CMD_customize_output_mode, PB_CMD_reset_output_mode, PB_CMD_cycle_coord_rotation and PB_CMD_check_plane_change_in_rapid_move.
  ...
  set mom_sys_alt_unit_post_name                "sim04_mill_4ax_tnc_mm__IN.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_home_pos(0)                       "330"
  set mom_sys_home_pos(1)                       "40"
  set mom_sys_home_pos(2)                       "580"
  set mom_sys_zero                              "0"
