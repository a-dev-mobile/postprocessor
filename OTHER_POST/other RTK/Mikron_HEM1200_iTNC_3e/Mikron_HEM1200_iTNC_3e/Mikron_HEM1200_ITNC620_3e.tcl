########################## TCL Event Handlers ##########################
#
#  Mikron_HEM1200_ITNC620_3e.tcl -
#
#  Created by ronconi  @  segunda-feira, 8 de janeiro de 2018 16:15:26 E. South America Daylight Time
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "Mikron_HEM1200_ITNC620_3e__IN.pui"
...
#=============================================================
   ...
   MOM_set_seq_on
   PB_CMD_cabecalho
   MOM_do_template Blank_Form1
   MOM_do_template blank_form2
...
global co ci
 ...
 MOM_output_literal "$co MAQUINA  : MIKRON HEM1200 - COMANDO: ITNC620 $ci"
...
#=============================================================
proc PB_CMD_cicle_abort { } {
#=============================================================
global mom_path_name


MOM_abort " ATENCAO: OPERACAO $mom_path_name -> CICLO NAO SUPORTADO!!"
}
...
#=============================================================
 ...
 # to ensure the hole Z height Q203 is set correctly.
  ...
  if { $mom_pos(2) != $mom_prev_pos(2) } {set cycle_init_flag  "TRUE"}
...
#=============================================================
proc PB_CMD_declaração_de_uso { } {
#=============================================================
MOM_output_to_listing_device " "
MOM_output_to_listing_device " "
MOM_output_to_listing_device " ================================================== "
MOM_output_to_listing_device " "
MOM_output_to_listing_device "                A T E N C A O ! ! !"
MOM_output_to_listing_device " "
MOM_output_to_listing_device " ================================================== "
MOM_output_to_listing_device " "
MOM_output_to_listing_device "   ESTE POS-PROCESSADOR FOI CONFIGURADO CONFORME"
MOM_output_to_listing_device " "
MOM_output_to_listing_device "  CONDIÇÃO PADRAO PARA O COMANDO CNC ESPECIFICADO"
MOM_output_to_listing_device " "
MOM_output_to_listing_device "  E FAZ PARTE DA BIBLIOTECA DA SIEMENS PLM BRASIL."
MOM_output_to_listing_device " "
MOM_output_to_listing_device "  ELE FOI CEDIDO PARA SER UTILIZADO COMO ESTÁ."
MOM_output_to_listing_device " "
MOM_output_to_listing_device " CASO SEJA NECESSÁRIO ALGUMA CUSTOMIZAÇÃO, FAVOR"
MOM_output_to_listing_device " "
MOM_output_to_listing_device "  ENTRAR EM CONTATO COM O SERVIÇO DE SUPORTE DA"
MOM_output_to_listing_device " "
MOM_output_to_listing_device "  SIEMENS PLM BRASIL PELO TELEFONE (11) 4228-7611."
MOM_output_to_listing_device " "
MOM_output_to_listing_device " "
MOM_output_to_listing_device " ================================================== "
}
...
#-- Atualizar estas variáveis com a letra e data da ultima revisao.... --------
 set usr_controle_rev    "C"
 set usr_data_rev    "03/ABR/13"
#------------------------------------------------------------------------------
...
#==============================================================================
# 19/MAI/10    ---    Kleber        - Liberacao inicial;
#------------------------------------------------------------------------------
# 01/dez/11     A    WRS        - Liberacao inicial para BTX;
#------------------------------------------------------------------------------
# 16/FEV/12     B    WRS        - Liberacao inicial para MAJE RECIFE;
#------------------------------------------------------------------------------
# 03/ABR/13     C    WRS        - Liberacao inicial para YPE;
#------------------------------------------------------------------------------
#
}
...
global co ci
 ...
 MOM_output_literal "$co OPERACAO: $mom_path_name - FERR.: T$mom_tool_number $ci"
 #MOM_output_literal "$co ======================================================================= $ci"
}
...
if {$mom_motion_event != "initial_move" && $mom_spindle_speed != $last_rpm} {
