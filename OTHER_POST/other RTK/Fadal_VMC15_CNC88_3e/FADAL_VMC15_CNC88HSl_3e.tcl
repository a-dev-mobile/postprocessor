########################## TCL Event Handlers ##########################
#
#  FADAL_VMC15_CNC88HSl_3e.tcl - 3_axis_mill
#
#    This is a 3-Axis Milling Machine.
#
#  Created by ronconi @ sexta-feira, 5 de janeiro de 2018 15:09:34 E. South America Daylight Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "FADAL_VMC15_CNC88HSl_3e__IN.pui"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_max_arc_radius                    "2000"
...
proc MOM_cycle_off { } {
#=============================================================
   MOM_force Once G_motion G_mode G X Y Z
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_adjust G_motion G_mode X Y Z D H}
   set rapid_spindle_x_blk {G_adjust G_motion G_mode X D H}
   set rapid_spindle_y_blk {G_adjust G_motion G_mode Y D H}
   set rapid_spindle_z_blk {G_adjust G_motion G_mode Z D H}
   set rapid_traverse_blk {G_motion G_mode X Y Z S M_spindle M_coolant}
   set rapid_traverse_xy_blk {G_motion G_mode X Y S M_spindle M_coolant}
   set rapid_traverse_yz_blk {G_motion G_mode Y Z S M_spindle M_coolant}
   set rapid_traverse_xz_blk {G_motion G_mode X Z S M_spindle M_coolant}
...
#=============================================================
   ...
   PB_CMD_cabecalho
   MOM_set_seq_on
   MOM_force Once G_cutcom G_plane G_mode G
...
global co ci
 ...
 MOM_output_literal "$co MAQUINA  : FADAL VMC15 - COMANDO: FADAL CNC 88HS $ci"
...
#==============================================================================
# 20/JAN/12    ---    William        - Liberacao inicial;
#------------------------------------------------------------------------------
#
#
#
