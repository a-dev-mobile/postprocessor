########################## TCL Event Handlers ##########################
#
#  Sinitron_B3NR_meldasM64_3e.tcl - 3_axis_mill
#
#    This is a 3-Axis Milling Machine.
#
#  Created by ronconi @ sexta-feira, 5 de janeiro de 2018 15:44:45 E. South America Daylight Time
...
#
  ...
  set mom_sys_alt_unit_post_name                "Sinitron_B3NR_meldasM64_3e__IN.pui"
...
set g40_flag          0
 ...
 MOM_output_literal "$co MAQUINA  : MEGATTON - SINITRON B3BR - COMANDO: MITSUBISHI MELDAS M64S $ci"
# MOM_output_literal "$co --------------------------------------------------------------  $ci"
# MOM_output_literal "$co POSPROCESSADOR: [ string toupper $mom_event_handler_file_name ] $ci"
# MOM_output_literal "$co REV.: [string toupper $usr_controle_rev ]   Data: [string toupper $usr_data_rev ]  $ci"
# MOM_output_literal "$co --------------------------------------------------------------  $ci"
}
...
#=============================================================
global g40_flag
global mom_sys_cutcom_code  mom_cutcom_status
...
if {$mom_cutcom_status == "UNDEFINED"} {
    set  g40_status    40
       ...
       set g40_status    $mom_sys_cutcom_code($mom_cutcom_status)
}

if {$g40_flag == 0 && $g40_status != "40"} {
    MOM_force once   D
    set g40_flag     1
} elseif {$g40_status == "40"} {
          MOM_suppress once   D
          set g40_flag        0
}
}
...
#==============================================================================
# 01/set/05    ---    Kleber        - Liberacao inicial;
#------------------------------------------------------------------------------
# 16/mar/06     A    Kleber        - Acresc. proc PB_CMD_force_D para sair
#                    o corretor de diametro.
#------------------------------------------------------------------------------
#
#
}
...
set mom_tool_change_type "MANUAL"
}
