########################## TCL Event Handlers ##########################
#
#  MIFTAHOV_4AXIS.tcl - 4_axis_table
#
#    QUASER MV154PL 4 Axis Milling Machine w Rotary Table
#
#  Created by miftahovirf @ 23 èþëÿ 2018 ã. 13:07:58 RTZ 2 (зима)
...
#                  PB_CMD_cal_feedrate_by_pitch_and_ss,PB_CMD__check_block_check_retract_setting and PB_CMD_cycle_hole_counter_flag.
  ...
  set mom_sys_alt_unit_post_name                "MIFTAHOV_4AXIS__IN.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_sim_cycle_tap_float               "0"
  set mom_sys_sim_cycle_tap_deep                "0"
  set mom_sys_sim_cycle_tap_break_chip          "0"
  ...
  set mom_sys_post_description                  "QUASER MV154PL 4 Axis Milling Machine w Rotary Table"
...
#=============================================================
   ...
   MOM_force Once G_mode G Y Z M_spindle
...
#=============================================================
  ...
  global mom_kin_max_fpm mom_motion_event
   ...
   MOM_do_template init_move_output_speed
   MOM_do_template initial_move_1_1
...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_motion G_mode G_adjust H X Y Z}
   set rapid_spindle_x_blk {G_motion G_mode G_adjust H X}
   set rapid_spindle_y_blk {G_motion G_mode G_adjust H Y}
   set rapid_spindle_z_blk {G_motion G_mode G_adjust H Z}
...
global mom_oper_program mom_output_file_basename mom_output_file_suffix
global mom_sys_control_in
global mom_sys_control_out

MOM_output_literal "O$mom_oper_program $mom_sys_control_out[string toupper $mom_output_file_basename.$mom_output_file_suffix]$mom_sys_control_in"
}
...
global mom_tool_corner1_radius mom_tool_lower_corner_radius mom_tool_upper_corner_radius
global mom_sys_control_in
global mom_sys_control_out

if { [string match "*Milling*" $mom_tool_name] } {
   if { [string match "*Milling Tool-T Cutter" $mom_tool_name] } {
   MOM_output_literal "$mom_sys_control_out$mom_tool_name$mom_sys_control_in"
   } else {
   MOM_output_literal "$mom_sys_control_out$mom_tool_name$mom_sys_control_in"
   }
} else {
...
#=============================================================
# cycle nanny
global mom_template_type        ;# drill or hole_making
...
global mom_operation_name
global mom_cycle_feed_to mom_cycle_retract_to
global mom_cycle_step1 mom_cycle_rapid_to
...
# catch JS-type user error
set t [expr abs($mom_cycle_feed_to) ]
if { $t < 0.001 } {
    incr alarm
    set tt "\n\n Zero Hole depth in cycle \n "
     set em $em$tt
   }

# peck is zero
if { $mom_cycle_step1 < 0.001 } {
   set ct [ MOM_ask_event_type ]
   if { $ct == "MOM_drill_deep_move" || $ct == "MOM_drill_break_chip_move" } {
    incr alarm
    set tt "\n Zero Peck Step in cycle \n "
     set em $em$tt
   }
}
    set tt "\n\n "
...
set mom_kin_retract_distance            50.0
...
#=============================================================
global mom_tool_corner1_radius ; set mom_tool_corner1_radius 0
}
...
if { [info exists mom_fixture_offset_value] } {
    ...
    if { $mom_fixture_offset_value > 6 } {
        set mom_fixture_offset_value 6
    }
}
