########################## TCL Event Handlers ##########################
#
#  Xmill.tcl - 4_axis_table
#
#    This is a 4-Axis Milling Machine With
#     Rotary Table.
#
#  Created by d.trofimov @ Friday, May 28 2021, 10:46:04 +0300
...
#                 - fix PR6961328 in MOM_lock_axis, comment out reload mom_pos in LOCK_AXIS_MOTION and lock mom_prev_pos in LINEARIZE_LOCK_MOTION
  ...
  set mom_sys_alt_unit_post_name                "Xmill__IN.pui"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_spindle_blk {G_motion X Y Z H S M_spindle M_coolant}
   set rapid_spindle_x_blk {G_motion X H S M_spindle M_coolant}
   set rapid_spindle_y_blk {G_motion Y H S M_spindle M_coolant}
   set rapid_spindle_z_blk {G_motion Z H S M_spindle M_coolant}
...
MOM_output_literal "G53 H0 Z0.0"
...
puts $ofile ";\T [GET_mom_tool_number] | \ [GET_mom_attr_TOOL_NAME_1] | \ [GET_mom_attr_TOOL_VYLET]";
#puts $ofile ";\ T number | \ T name | \ VYLET";
