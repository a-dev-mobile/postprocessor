########################## TCL Event Handlers ##########################
#
#  rtk_dmc635_4axis.tcl - 4_axis_table
#
#    This is a 4-Axis Milling Machine With
#     Rotary Table.
#
#  Created by d.trofimov @ Wednesday, July 14 2021, 20:09:22 +0300
...
#
  ...
  set mom_sys_alt_unit_post_name                "rtk_dmc635_4axis__IN.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_home_pos(0)                       "-630"
  set mom_sys_home_pos(1)                       "-5"
  set mom_sys_home_pos(2)                       "-5"
  set mom_sys_zero                              "0"
...
#=============================================================
proc PB_CMD_Header_tool_list_1 { } {
#=============================================================
...
puts $ofile ";\ [GET_mom_attr_TOOL_NAME_1] | \ [GET_mom_attr_TOOL_VYLET] VYLET \ ";
...
#=============================================================
proc PB_CMD_VYLET_AND_NAME_TOOL { } {
#=============================================================
...
proc PB_CMD_VYLET_AND_NAME_tool { } {
#=============================================================
MOM_output_text "T= [GET_mom_tool_name]"
MOM_output_text "; VYLET = [format "%0.0f" [GET_mom_tool_zmount]] mm"
}
...
proc PB_CMD_ZAG { } {
#=============================================================
MOM_output_literal "WORKPIECE(,\"\"\,,\"RECTANGLE\",64,0.5,-55,-80,320,230)"
}
...
foreach name [ARRAY_INFO_START_PROGRAMM 26] {
MOM_output_text $name
}
MOM_output_text "; ---"
