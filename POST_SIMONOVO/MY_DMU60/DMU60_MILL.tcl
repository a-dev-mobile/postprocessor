...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "DMU60_MILL__IN.pui"
...
#=============================================================
  ...
  # Accumulated time should be in minutes.
   ...
   if { [PB_CMD__check_block_return_to_reference_point] } {
      MOM_force Once Text G_motion Text
      MOM_do_template tool_change_return_home_XY
   }
   if { [PB_CMD__check_block_return_to_reference_point] } {
      MOM_force Once Text G_motion fourth_axis_home fifth_axis_home
      MOM_do_template tool_change_return_home_BC
   }
...
#=============================================================
  ...
  global mom_sys_machine_time mom_machine_time
   ...
   MOM_output_literal ";Metod : $mom_oper_method"
   MOM_output_literal "; "
...
#
   global mom_Instruction
   MOM_output_text "$mom_Instruction"
}
...
#-----------------------------------------------------------
   set cycle800_tc "\"DMG\"" ;# For example,please put your data here
...
#=============================================================
global coord_angle(0)
global coord_angle(1)
global coord_angle(2)

# MOM_output_literal "mom_out_angle_pos(0) $mom_out_angle_pos(0)"
 MOM_output_literal "coord_angle(0) $coord_angle(0)"
 MOM_output_literal "coord_angle(1) $coord_angle(1)"
 MOM_output_literal "coord_angle(2) $coord_angle(2)"
}
...
#=============================================================
  MOM_force once G_motion X Y Z D M
 MOM_force_block Once spindle_rpm coolant_on

}


#=============================================================
proc PB_CMD_my_reset_rot { } {
#=============================================================
#MOM_output_literal "G0 B0.0 C=DC(0.0)"
}
...
#
  ...
  if { ![info exists start_output_flag] || $start_output_flag == 0 } {
    ...
    # MOM_output_literal ";DATE TIME   :$mom_date"
     ...
     MOM_output_literal ";"
 MOM_output_literal "WORKPIECE(,\"C\",,\"BOX\",112,0,-108,0,76,64.5,-76,-64.5)"
...
#=============================================================
proc PB_CMD_return_ref_point { } {
#=============================================================
MOM_output_literal "SUPA G0 Z=_Z_HOME D0"
MOM_output_literal "SUPA X=_X_HOME Y=_Y_HOME"
MOM_output_literal "SUPA B=_B_HOME C=DC(_C_HOME)"
}
...
# set dpp_coord_rotation_output_type "TRAORI" ; # SWIVELING / TRAORI (+AROT)
 ...
 set dpp_coord_rotation_output_type "SWIVELING"; # / TRAORI (+AROT)
 #set dpp_coord_rotation_output_type "TRAORI"
  if { ![info exists sinumerik_version] } {
return
  }
...
foreach s [ARRAY_INFO_START_PROGRAMM 2] {
   ...
   set mom_pb_macro_arr(CYCLE800_sl) \
       [list {CYCLE800 ( , ) 0 {}} \
        {{1 0} \
         ...
         {{$mom_out_angle_pos(1)} 1 5 5 1 1 10 5} \
         {{$mom_out_angle_pos(0)} 1 5 5 1 1 10 5} \
         {{$mom_out_angle_pos(2)} 1 5 5 1 1 10 5} \
         {0 0} \
         {0 0} \
         {0 0} \
         {{$cycle800_dir} 1 0 2 0 0 2} \
