...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "DMU60_TURN__IN.pui"
...
global mom_flip_a_axis
 ...
 set mom_out_angle_pos(0) [format "%0.3f" [expr $mom_tool_holder_angle_for_cutting*$RAD2DEG]]

     if {[info exist mom_flip_a_axis] && $mom_flip_a_axis == 1 } {
          set tool_holder_spindle_axis 180
        } else { set tool_holder_spindle_axis 0 }
...
#=============================================================
proc PB_CMD__check_block_CYCLE95_sl_1 { } {
#=============================================================
...
#=============================================================
proc PB_CMD_end_path { } {
#=============================================================
 MOM_output_literal "G97 S2=0 M2=5"
 MOM_output_literal "SUPA G0 Z=_Z_HOME D0"
 MOM_output_literal "SUPA G0 B=_B_HOME D0"
 #MOM_output_literal "CYCLE800(0,\"DREHEN\",200,57,,,,0,0,0,,,,-1,100,2)"
 MOM_output_literal "CYCLE800(0,\"0\",200,57,,,,0,0,0,,,,-1,100,2)"
 MOM_output_literal "DM_MILL"
...
#=============================================================
MOM_force once G_feed G_motion G_mode Z X F S_limit
...
#=============================================================
proc PB_CMD_start_info { } {
#=============================================================
 foreach s [ARRAY_INFO_START_PROGRAMM 21] {
...
MOM_output_text $s
 ...
 MOM_output_literal "DEF REAL _X_HOME, _Y_HOME, _Z_HOME, _B_HOME, _C_HOME"
 MOM_output_literal ";========================"
 MOM_output_literal " WORKPIECE(,,,\"CYLINDER\",0,1,-60,-80,280)"
 MOM_output_literal ";========================"
 MOM_output_literal "G17 G40 G64 G90"
 MOM_output_literal "_X_HOME=-650. _Y_HOME=-1. _Z_HOME=-1."
 MOM_output_literal "_B_HOME=0 _C_HOME=0"

 MOM_output_literal "SUPA G0 Z=_Z_HOME D0"
 MOM_output_literal "SUPA G0 X=_X_HOME Y=_Y_HOME B=_B_HOME C=DC(_C_HOME) D0"
...
#=============================================================
   ...
   set mom_pb_macro_arr(CYCLE95_sl_1) \
       [list {CYCLE800 ( , ) 0 {}} \
        {{0 0} \
         {{\"DREHEN\"} 0} \
         {200 0} \
         ...
         {} \
         {} \
         {{$mom_out_angle_pos(0)} 1 3 3 1 1 6 3} \
         {{$tool_holder_spindle_axis} 1 1 3 0 0 3} \
         {} \
         {} \
         {} \
         {-1 0} \
