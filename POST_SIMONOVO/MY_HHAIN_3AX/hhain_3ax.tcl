...
#  hhain_3ax.tcl -
#
#  Created by Admin  @  27 íîÿáðÿ 2017 ã. 22:41:19 RTZ 2 (зима)
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "hhain_3ax__IN.pui"
...
########## SYSTEM VARIABLE DECLARATIONS ##############
  ...
  set mom_sys_circle_code(CLW)                  "CR"
  set mom_sys_circle_code(CCLW)                 "CR"
  ...
  set mom_sys_cycle_start_code                  "CYCL CALL "
  set mom_sys_cycle_off                         ""
  set mom_sys_cycle_drill_code                  "CYCL CALL "
  set mom_sys_cycle_drill_dwell_code            "CYCL CALL "
  set mom_sys_cycle_drill_deep_code             "CYCL CALL "
  set mom_sys_cycle_drill_break_chip_code       "CYCL CALL "
  set mom_sys_cycle_tap_code                    "CYCL CALL "
  set mom_sys_cycle_bore_code                   "CYCL CALL "
  set mom_sys_cycle_bore_drag_code              "CYCL CALL "
  set mom_sys_cycle_bore_no_drag_code           "CYCL CALL "
  set mom_sys_cycle_bore_dwell_code             "CYCL CALL "
  set mom_sys_cycle_bore_manual_code            "CYCL CALL "
  set mom_sys_cycle_bore_back_code              "CYCL CALL "
  set mom_sys_cycle_bore_manual_dwell_code      "CYCL CALL "
  ...
  set mom_sys_seqnum_max                        "9999999"
  ...
  set mom_sys_post_description                  "iTNC-530 3ax"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_4th_axis_max_limit                "720"
  set mom_kin_4th_axis_min_incr                 "0.001"
  set mom_kin_4th_axis_min_limit                "-720"
...
#=============================================================
   ...
   CIRCLE_SET
   PB_CMD_circle_definition
   MOM_do_template circular_move_hhain
}
...
#=============================================================
  global feed_mode mom_feed_rate mom_kin_rapid_feed_rate
   ...
   MOM_do_template linear_move_hhain
}
...
#=============================================================
   ...
   PB_CMD_cycle_pos_feed
   PB_CMD_user_tapping_new
   MOM_do_template cycle_tap_1
   PB_CMD_user_tapping_call
   PB_CMD_cycle_time
   set cycle_init_flag FALSE
}
...
set ARR2([GET_mom_tool_name]) [format "%0.1f" [GET_mom_tool_zmount]]
set ARR3([GET_mom_tool_name]) [format "%0.1f" [GET_mom_tool_diameter ]]
...
if {$arg1 == 1} {
lappend all_text  "\nTOOL_NAME: name $name | VYLET L = $ARR2($name)"
}

if {$arg1 == 2} {
lappend all_text  "          "
lappend all_text  "D = $ARR3($name) | R = $ARR5($name) | L = $ARR2($name) | T =  $ARR4($name) | $name"
}
if {$arg1 == 0} {
...
#=============================================================
proc PB_CMD_MY_START_OPERATION { } {
#=============================================================


global is_skip
set is_skip [SKIP_TO_END_OF_PATCH [GET_user_type_isp] [GET_mom_operation_name] [ARRAY_GET_ALL_TYPE_DETAIL]]
...
if { $mom_oper_tool == "NONE" } {
      ...
      MOM_output_literal "* - ZERO TOOL T0"
      MOM_output_literal "TOOL CALL 0 Z"
      MOM_output_text ";======================================"

      set user_saved_spindle_speed 0
} else {
...
#=============================================================
global mom_temp_time mom_machine_time

set mom_temp_time $mom_machine_time
}
...
global mom_output_file_basename
  ...
  MOM_output_text ";======================================"
  MOM_output_text ";POSTPROCESSOR : TNC 530 3AX"
  MOM_output_text ";$mom_part_name"
  MOM_output_text ";DATE $mom_date :  USER - $mom_logname"
  MOM_output_text ";======================================"
  MOM_set_seq_on
}
...
global mom_pos_arc_plane
 ...
 if { $mom_pos_arc_plane == "ZX" } {
      MOM_force once X Z R
      MOM_suppress once Y
  }

 if { $mom_pos_arc_plane == "YZ" } {
      MOM_force once Y Z R
      MOM_suppress once X
  }
}
...
#=============================================================
MOM_force once X Y G_cutcom
MOM_add_to_line_buffer end " M110"
#MOM_add_to_line_buffer end " M120 LA99"
}


#=============================================================
proc PB_CMD_cutcom_unforce { } {
#=============================================================
MOM_force once X Y G_cutcom
MOM_add_to_line_buffer end " M111"
}
...
set user_cycle_z_coord [format "%0.3f" [expr $mom_cycle_rapid_to_pos(2)-$mom_cycle_rapid_to]]
set user_cycle_param_list [format "%0.3f" $mom_cycle_rapid_to_pos(2)]
...
###   Hhain data
  ...
  if { ![info exist mom_bmg_direction] } { set mom_bmg_direction CCLW }
...
if { [info exist user_reposition_z] } {
     unset user_reposition_z
}
if { [info exist mom_cycle_counter_sink_dia] } {
     unset mom_cycle_counter_sink_dia
}
...
#=============================================================
proc PB_CMD_cycle_pos_feed { } {
#=============================================================
global mom_programmed_feed_rate cycle_pos_feed

if { [EQ_is_equal $mom_programmed_feed_rate 0] } {
      set cycle_pos_feed "MAX"
} else {
      set cycle_pos_feed [format "%0.0f" $mom_programmed_feed_rate]
}
MOM_force once G_motion f_max X Y Z
}
...
#MOM_output_text [SET_comment ""]
#MOM_output_text [SET_comment "===="]
#MOM_output_text [VIEW_TEXT "TOOL_LIST" 1]
...
MOM_do_template circle_center
   ...
   for { set h_a $mom_arc_angle } {$h_a > 0.0} {set h_a [expr $h_a - 3600.0]} {
       if { $h_a < 3600.0 } {
         set helix_angle [expr $h_a * $helix_mod]
         set helix_pitch [expr $mom_helix_pitch / 360.0  * $h_a]
           } else {
         set helix_angle [expr 3600.0 * $helix_mod]
         set helix_pitch [expr $mom_helix_pitch / 360.0  * 3600.0]
                   }

set helix_block "CP"
append helix_block " IPA[format "%0.3f" $helix_angle]"
append helix_block " IZ[format "%0.3f" $helix_pitch]"
...
#     MOM_output_literal ";************************************"
     MOM_output_literal "* - ZERO TOOL T0"
     MOM_output_literal "M140 MB MAX FMAX"
...
#     MOM_output_literal ";************************************"
     MOM_output_literal "* - T$mom_tool_number $mom_tool_name"
   #  MOM_output_literal "M140 MB MAX FMAX"
     MOM_output_literal "M0; RUCHNAIA SMENA INSTRUMENTA"
     #MOM_output_literal "M06"
     MOM_output_literal "TOOL CALL $mom_tool_number Z [format "S%0.0f" $mom_spindle_speed]"
      MOM_output_text ";======================================"
#     MOM_output_literal ";************************************"
...
#=============================================================
if {![COMPARE__TEXT_TEXT [GET_mom_operation_type] "Mill Machine Control"]} {
MOM_output_text [SET_INFO_START_WORK 5]
...
#=============================================================
proc PB_CMD_spindle_speed_user { } {
#=============================================================
global mom_spindle_speed
global mom_oper_tool mom_tool_number
global user_saved_spindle_speed
...
if { ![info exist user_saved_spindle_speed] } {
     set user_saved_spindle_speed 0.0
}
set mom_spindle_speed [format "%0.0f" $mom_spindle_speed]

if { $mom_spindle_speed != 0.0 && $user_saved_spindle_speed != $mom_spindle_speed } {
MOM_output_literal "TOOL CALL $mom_tool_number Z S$mom_spindle_speed"
set user_saved_spindle_speed $mom_spindle_speed
}
}
...
MOM_force once X Y Z F M_spindle M_coolant
...
if { [info exist user_saved_spindle_speed] } {
     unset user_saved_spindle_speed
}
...
MOM_output_literal "CYCL DEF 247 NAZN.KOORD.BAZ.TOCH ~"
MOM_output_text "    Q339=+1 ;NOMER TOCHKI ODN."
...
set user_cycle_z_coord [expr $mom_cycle_rapid_to_pos(2) - $mom_cycle_rapid_to]
set user_cycle_z_coord [format "%0.3f" $user_cycle_z_coord]
...
#=============================================================
proc PB_CMD_user_cycle_definition { } {
#=============================================================
uplevel #0 {
#==========================================
proc MOM_drill_text_move {} {
...
if { $mom_cycle_text == "G208" } {
      PB_CMD_set_cycle_plane
      PB_CMD_cycle_pos_feed
      PB_CMD_bore_milling
#      MOM_force once G_motion f_max
      MOM_do_template cycle_pos_block
      MOM_do_template cycle_call_block
} elseif { $mom_cycle_text == "G262" } {
      PB_CMD_set_cycle_plane
      PB_CMD_cycle_pos_feed
      PB_CMD_thread_milling
#      MOM_force once G_motion f_max
      MOM_do_template cycle_pos_block
      MOM_do_template cycle_call_block
}
...
#     MOM_cycle_thread_milling_move
      ...
      PB_CMD_read_cycle_pos_list
      PB_CMD_cycle_pos_feed
      PB_CMD_cycle_threadmilling_data
      PB_CMD_cycle_thread_milling
      MOM_do_template cycle_pos_block
      MOM_do_template cycle_call_block
...
#     MOM_boss_milling_move
      PB_CMD_set_cycle_plane
      PB_CMD_cycle_pos_feed
      PB_CMD_cycle_boss_milling_data
      PB_CMD_cycle_boss_milling
      MOM_do_template cycle_pos_block
      MOM_do_template cycle_call_block
...
#     MOM_boss_thread_milling_move
      PB_CMD_set_cycle_plane
      PB_CMD_cycle_pos_feed
      PB_CMD_cycle_boss_threadmilling_data
      PB_CMD_cycle_out_thread_milling
      MOM_do_template cycle_pos_block
      MOM_do_template cycle_call_block
...
#     MOM_hh_chamfer_move
      PB_CMD_set_cycle_plane
      PB_CMD_cycle_pos_feed
      PB_CMD_cycle_chamfer_milling
      MOM_force_block once chamfer_1
      MOM_do_template chamfer_1
      MOM_force_block once chamfer_2
      MOM_do_template chamfer_2
      MOM_force_block once chamfer_3
      MOM_do_template chamfer_3
      MOM_force_block once chamfer_4
      MOM_do_template chamfer_4
      MOM_force_block once chamfer_5
      MOM_do_template chamfer_5
      MOM_force_block once chamfer_6
      MOM_do_template chamfer_6
 }
}
...
#=============================================================
proc PB_CMD_user_drill_break_chip { } {
#=============================================================
global user_cycle_saved_param_list
...
if { [info exist mom_cycle_taps_number] && $mom_cycle_taps_number > 1 } {
       set user_cycle_tap_step [expr $mom_cycle_feed_to / $mom_cycle_taps_number ]
} elseif { [info exists mom_cycle_step1] && $mom_cycle_step1 > 1 } {
       set user_cycle_tap_step $mom_cycle_step1
} elseif {[info exists user_cycle_tap_step]} {
       unset user_cycle_tap_step
  }

if { [info exist mom_cycle_taps_number] && $mom_cycle_taps_number > 1 } {
     for { set i 1} { $i <= $mom_cycle_taps_number } { incr i } {
           set user_cycle_depth [expr $user_cycle_tap_step * $i]
           MOM_output_literal "; STOP"
           MOM_output_literal "Q201=[format "%0.1f" $user_cycle_depth]; STEP $i"
           MOM_output_literal "CYCL CALL"
         }
} else {
         MOM_output_literal ";STOP"
         MOM_output_literal "CYCL CALL"
...
set user_cycle_clearance [format "%0.3f" $mom_cycle_rapid_to]
set user_cycle_z_coord [format "%0.3f" $mom_pos(2)]
# set user_cycle_z_coord [expr $mom_cycle_rapid_to_pos(2) - $mom_cycle_rapid_to]
# set user_cycle_z_coord [format "%0.3f" $user_cycle_z_coord]
set user_cycle_param_list [format "%0.3f" $mom_cycle_rapid_to_pos(2)]
#===============================
...
if { [info exist mom_tool_pitch] } {
     set user_cycle_pitch [format "%0.4f" $mom_tool_pitch]
} else {
     set user_cycle_pitch [format "%0.4f" $mom_cycle_feed_rate_per_rev]
}
...
global mom_cycle_taps_number
global mom_narezanie_rezbi_za_neskolko_raz
if { [info exist mom_cycle_taps_number] && $mom_cycle_taps_number > 0 } {
## lappend user_cycle_param_list $mom_cycle_taps_number
} elseif { [info exist mom_narezanie_rezbi_za_neskolko_raz] } {
set mom_cycle_taps_number $mom_narezanie_rezbi_za_neskolko_raz
} else {
set mom_cycle_taps_number 1
}
#===============================
...
MOM_output_text "    Q206=[format "%0.1f" $mom_cycle_feed_rate]  ; ~"
