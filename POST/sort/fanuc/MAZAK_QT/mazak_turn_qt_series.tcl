########################## TCL Event Handlers ##########################
#
#  mazak_turn_qt_series.tcl -
#
#  Created by danilov  @  14 ÿíâàðÿ 2015 ã. 16:43:00 RTZ 2 (зима)
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "mazak_turn_qt_series__IN.pui"
...
#============================
global mom_pos
global mom_start_pos
global mom_mazak_machine_name

 if {[info exist mom_mazak_machine_name] && \
      [string match "*QTS*" $mom_mazak_machine_name]} { return }

if { ![info exist mom_start_pos] } {
     set mom_start_pos $mom_pos(2)
   } else { set mom_pos(2) $mom_start_pos }
}
...
global mom_start_pos mom_pos
global mom_motion_type

if { $mom_motion_type == "TRAVERSAL" && [info exist mom_start_pos] } {
     set mom_pos(2) $mom_start_pos
   }
...
if { [info exist mom_start_pos] } { catch [unset mom_start_pos] }
