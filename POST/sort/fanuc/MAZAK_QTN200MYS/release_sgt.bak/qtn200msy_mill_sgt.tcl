...
#
#  Created by danilov  @  21 èþíÿ 2017 ã. 14:34:01 RTZ 2 (зима)
...
SYNCHRO_OFF
  ...
  if { $subspin_opt == 2 } {
   ...
   if { $subspin_opt != 0 } {
          ...
          MOM_output_text "(\#3024=\#511 Var 3024 Updates MCS MAZATROL )"
      }
...
global Var503 Var504 Var505 Var506
  ...
  MOM_output_text "(===================================)"
   if {[catch {MOM_ask_ess_exp_value "var502"}] == 0 } {
           ...
           MOM_output_text "\#502=$var502 (SET PART LENGTH)"
    } else {
...
SYNC_mode ON
  ...
  MOM_output_text "(PARAMETRIC TAKE PART COMPLETED)"
  # MOM_output_text "N99992 (SKIP LABEL)"
  MOM_force once G_mode G_motion G_feed
...
SYNCHRO_OFF
  ...
  if { $subspin_opt == 0 } {
   ...
   # MOM_output_text "N99993 (SKIP LABEL)"
   MOM_force once G_mode G_motion G_feed
   if {[info exists mom_qtn_var505] } { unset mom_qtn_var505 }
}
