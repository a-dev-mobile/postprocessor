########################## TCL Event Handlers ##########################
#
#  mazak_qtn200mys_turn.tcl -
#
#  Created by danilov  @  20 àïðåëÿ 2017 ã. 13:51:48 RTZ 2 (зима)
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "mazak_qtn200mys_turn__IN.pui"
...
if {$mom_spindle_direction != $direction} {
     MOM_force_block once end_of_path
...
MOM_force once G_feed G_mode G_motion F
}
...
#=============================================================
proc PB_CMD_program_end_ { } {
#=============================================================
global mom_sum_time
   MOM_output_literal "( TIME : [format "%0.1f" $mom_sum_time])"

global mom_barfeeder_stop_tool
if { [info exist mom_barfeeder_stop_tool] } {
     MOM_output_literal "M99"
} else { MOM_output_literal "M30" }
...
#=============================================================
proc PB_CMD_rapid_first { } {
#=============================================================
global delay_first_move

if { [info exist delay_first_move] && $delay_first_move == "YES"} {
     catch [unset delay_first_move]
     MOM_force once G_mode G_motion G_feed F
}
}
...
MOM_do_template y0
MOM_force once G_plane G_feed G_motion G_mode F M_coolant
}
