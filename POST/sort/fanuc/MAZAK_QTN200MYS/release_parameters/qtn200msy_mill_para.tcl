########################## TCL Event Handlers ##########################
#
#  qtn200msy_mill_para.tcl -
#
#  Created by danilov  @  18 ìàÿ 2017 ã. 17:16:20 RTZ 2 (зима)
...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "qtn200msy_mill_para__IN.pui"
...
#=========================
 ...
 set mom_sys_postname(TURN)                    "qtn200msy_turn_para"
  ...
  MOM_output_text "(===================================)"
    ...
    if {[info exists mom_qtn_setup_v521_defined] && $mom_qtn_setup_v521_defined == 1 } {
           ...
           MOM_output_text "\#521=[format %0.4f $mom_qtn_setup_v521] (SUBCHUCK AND JAWS LENGTH)"
                       ...
                       set var502_expr "var502"

   if {[catch {MOM_ask_ess_exp_value $var502_expr}] == 0 } {
           set var502 [format "%0.4f" [MOM_ask_ess_exp_value $var502_expr]]
           MOM_output_text "\#502=$var502 (NX VARIABLE. DETAL LENGTH)"

    } elseif {[info exists mom_qtn_setup_var502_defined] && $mom_qtn_setup_var502_defined == 1 } {
           MOM_output_text "\#502=[format %0.4f $mom_qtn_setup_v502] (USER DEFINED. DETAL LENGTH)"
       }
##
...
MOM_output_text "( POST VERSION 17.05 PARAMETRIC )"
...
set mom_var511 "0"
MOM_output_text "(===================================)"
MOM_output_text "\#511=0.0 (SMESHENIE 0 PO OSI Z)"
MOM_output_text "(===================================)"
MOM_output_literal "G53.5"
