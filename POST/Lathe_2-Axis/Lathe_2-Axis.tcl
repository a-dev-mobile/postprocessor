########################## TCL Event Handlers ##########################
#
#  Lathe_2-Axis.tcl - lathe
#
#    This is a 2-Axis Horizontal Lathe Machine.
#
#  Created by trofimovdi @ Wednesday, October 24 2018, 10:43:41 +0300
...
#
  ...
  set mom_sys_alt_unit_post_name                "Lathe_2-Axis__IN.pui"
...
#=============================================================
proc MOM_center_start { } {
#=============================================================
   global mom_center_status
}
...
#=============================================================
  ...
  # Accumulated time should be in minutes.
   ...
   PB_CMD_SOG_END
   PB_CMD_GET_mom_operation_notes
...
#=============================================================
proc PB_CMD_END_OBRAB { } {
#=============================================================
if {![COMPARE__TEXT_TEXT [GET_mom_operation_type] "Lathe Machine Control"]} {
MOM_output_text  "M1"
}
...
#=============================================================
proc PB_CMD_GET_mom_operation_notes { } {
#=============================================================
...
set a3 [SET_comment  "Machine: Akira-Seiki Performa V3"]
set a4 [SET_comment  "File: [GET_mom_output_file_full_name]"]

set a "$a0`$a1`$a2`$a21`$a3`$a4`$a0"
return  [SPLIT_TEXT $a]
}
...
#=============================================================
proc PB_CMD_MY_CENTER { } {
#=============================================================
global mom_center_status

if {[info exist mom_center_status] } {
#MOM_output_text "--------$mom_center_status"
#MOM_output_text "1111111111111"
  } else  {
#MOM_output_text "222222222"
}
...
#=============================================================
proc PB_CMD_MY_from_pos { } {
#=============================================================
global mom_pos


set x [expr "$mom_pos(0) * 2"]


#MOM_output_text "G00 X[format "%0.0f" $x]"

MOM_output_text "G00 Z[format "%0.0f" $mom_pos(2)]"
}
...
#
 ...
 MOM_force once F
  ...
  if {[string compare "RPM" $mom_spindle_mode] } {
   ...
   MOM_force once M_spindle S G G_spin
#MOM_output_text  "G97 S[format "%0.0f" $mom_spindle_maximum_rpm]"
     MOM_do_template spindle_css
...
#=============================================================
proc PB_CMD_start_programm { } {
#=============================================================

MOM_output_literal "[GET_mom_group_name] ([GET_mom_output_file_basename])"

foreach name [ARRAY_INFO_START_PROGRAMM 25] {
MOM_output_text $name
}
...
MOM_output_text "G54 T0[GET_mom_tool_number]0[GET_mom_tool_number] ([GET_mom_tool_name])"
...
#=============================================================
proc PB_CMD_top_programm { } {
#=============================================================
if {![COMPARE__TEXT_TEXT [GET_mom_operation_type] "Lathe Machine Control"]} {
MOM_output_text "G28 U0 W0"
MOM_output_text  "G99 G54 G40 G80 G21 "
