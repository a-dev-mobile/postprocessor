...
########################################################################
  ...
  if { ![info exists mom_sys_post_initialized] } {
   ...
   ####  Listing File variables 
     ...
     set mom_sys_alt_unit_post_name                "DMU65__IN.pui"
...
####### KINEMATIC VARIABLE DECLARATIONS ##############
  ...
  set mom_kin_4th_axis_max_limit                "3"
...
proc MOM_blank_data { } {
#=============================================================
   global mom_blk_x_min
   global mom_blk_y_min
   global mom_blk_z_min
   global mom_blk_x_max
   global mom_blk_y_max
   global mom_blk_z_max
}
...
#=============================================================
  ...
  # Accumulated time should be in minutes.
   ...
   if { [PB_CMD__check_block_return_home] } {
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_motion X Y Z fourth_axis fifth_axis G_cutcom FMAX M_spindle M_coolant}
...
#=============================================================
proc PB_CMD_PLANE_RESET_TURN { } {
#=============================================================

MOM_output_literal "L ZQ503 R0 FMAX M91"
...
# 10-18-13 JSF - Behavior change: no home return in the end of path if there is no tool change in next operation. Home return if it is the last operation. Modified in PB_CMD_check_block_return_to_reference_point.
#              - Behavior change: table axis will not return to zero if the tool vector turn to be along Z axis in cycle plane change or in rapid move. Modified in PB_CMD_cycle_coord_rotation & PB_CMD_check_plane_change_in_rapid_move.
...
MOM_output_literal "PLANE RESET TURN FMAX"
 MOM_output_literal "PLANE SPATIAL SPA0.0000 SPB0.0000 SPC[format "%0.3f" $mom_out_angle_pos(1)] TURN FMAX SEQ- TABLE ROT"
...
#=============================================================
proc PB_CMD_check_plane_change_in_rapid_move_1 { } {
#=============================================================
# Check for the tool axis change during rapid move using AUTO_3D function
#
# 06-18-2012 Jason - Initial version
...
#MOM_force_block Once irapid_xy
MOM_force once G_motion X Y
MOM_force once Z M_spindle F
MOM_force_block  Once coolant_on
...
MOM_output_literal "L Z-10 FMAX M91; Z GO HOME"
...
# <06-18-2013 Jason> - Initial version
  ...
  #set dpp_ge(coord_rot) "LOCAL_CSYS"
